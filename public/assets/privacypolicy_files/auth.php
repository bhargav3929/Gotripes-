...
break;}}
if(linkfound==false){var div=document.createElement('div');div.id='error_9797eb3430fb7e03ce165854a5acd046607fff3a';div.innerHTML='<a href="https://www.freevisitorcounters.com/en/home/countercode/hashid/?id=9797eb3430fb7e03ce165854a5acd046607fff3a">Counter Error: Do not change the code. Click here to show the correct code!</a>';if(document.getElementById('counterimg')!=null){document.getElementById('counterimg').parentNode.insertBefore(div,document.getElementById('counterimg').nextSibling);}else{document.body.appendChild(div);}

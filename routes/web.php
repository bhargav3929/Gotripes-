...
Route::prefix('/')->group(function () {
    ...
    Route::get('seed-umrah-packages', function() {
        ...
        // Generate dynamic Wednesday dates that are at least 5 days in the future
        $wed1 = date('Y-m-d', strtotime('next Wednesday'));
        $wed2 = date('Y-m-d', strtotime('next Wednesday + 1 week'));
        $wed3 = date('Y-m-d', strtotime('next Wednesday + 2 weeks'));

<?php $__env->startSection('title', 'Add Media to TV'); ?>
...
<div class="row">
    <div class="col-lg-8">
        <form action="<?php echo e(route('manager.adslots.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="wp-card-body">
                    <div class="wp-form-group">
                        ...
                        <select class="wp-select" id="slotOrder" name="slotOrder" required style="max-width: 250px;">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e(request('tv') == $i ? 'selected' : ''); ?>>
                                    TV <?php echo e($i); ?>

                                    <?php if(in_array($i, $usedSlots ?? [])): ?>
                                        (has media)
                                    <?php else: ?>
                                        (empty)
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/manager/adslots/create.blade.php ENDPATH**/ ?>
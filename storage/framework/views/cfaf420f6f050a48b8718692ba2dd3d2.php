<?php $__env->startSection('title', 'Manage Travel Packages'); ?>

<?php $__env->startSection('page-title', 'Manage Travel Packages'); ?>
                ...
                <div class="card-body p-2 p-sm-3 p-md-4">
                    ...
                    <div class="d-block d-lg-none">
                        ...
                        <div class="card bg-light-dark border-gold mb-3 mobile-card animate-scale">
                            <div class="card-body p-3">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-1">
                                            <span class="text-gold fw-bold" style="font-size: 1.1rem;">
                                                AED <?php echo e(number_format($package->price, 2)); ?>
                                    ...
                                    <div class="ms-2">
                                        <img src="<?php echo e(asset($package->image)); ?>"
                                ...
                                <div class="mb-3">
                                    <small class="text-light-muted">
                                        ...
                                        <?php echo e($package->createdDate ? \Carbon\Carbon::parse($package->createdDate)->format('M d, Y') : 'N/A'); ?>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="button"
                                            ...
                                            data-package-title="<?php echo e(Str::limit($package->title, 30)); ?>">
                        ...
                        <div class="pkg-empty-state text-center">
                            ...
                            <a href="<?php echo e(route('admin.packages.create')); ?>" class="pkg-empty-btn">
                            ...
                            <table class="table table-dark table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-white fw-semibold"><?php echo e($package->title); ?></span>
                                        ...
                                        <td>
                                            <span class="text-gold fw-bold">AED <?php echo e(number_format($package->price, 2)); ?></span>
                                        </td>
                                        <td>
                                            <span class="badge bg-info-custom">
                                                <i class="fas fa-clock me-1"></i><?php echo e($package->duration); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        if (currentPackageId) {
            ...
            deleteForm.action = `<?php echo e(route('admin.packages.index')); ?>/${currentPackageId}`;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/packages/index.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('page-title', 'Add Media to TV'); ?>
...
<div class="row justify-content-center">
    <div class="col-12 col-lg-8">
        <div class="card border-0 animate-fade-in">
            ...
            <form method="POST" action="<?php echo e(route('admin.homepageads.store')); ?>" enctype="multipart/form-data" id="mediaForm">
                <?php echo csrf_field(); ?>
                        ...
                        <select class="form-control" id="slotOrder" name="slotOrder" required>
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <option value="<?php echo e($i); ?>"
                                    <?php echo e((request('tv') == $i || old('slotOrder') == $i) ? 'selected' : ''); ?>>
                                    TV <?php echo e($i); ?>
                    ...
                    <div class="mb-4" id="durationGroup">
                        ...
                        <div class="input-group" style="max-width: 200px;">
                            <input type="number" class="form-control" id="duration" name="duration"
                                   value="<?php echo e(old('duration', 5)); ?>" min="1" max="60">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/homepageads/create.blade.php ENDPATH**/ ?>
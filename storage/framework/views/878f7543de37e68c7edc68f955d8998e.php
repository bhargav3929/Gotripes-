...
<div class="container" style="max-width: 960px;">
    ...
    <div class="balance-strip mb-4">
        <div class="balance-item balance-item--main">
            ...
            <div class="balance-amount" id="availableBalanceDisplay">AED <?php echo e(number_format($availableBalance, 2)); ?></div>
        </div>
        <div class="balance-sep"></div>
        <div class="balance-item">
            <div class="balance-label">Pending Withdrawal</div>
            <div class="balance-amount balance-amount--muted">AED <?php echo e(number_format($pendingWithdrawalAmount, 2)); ?></div>
        </div>
        <div class="balance-sep"></div>
        <div class="balance-item">
            <div class="balance-label">Min. Withdrawal</div>
            <div class="balance-amount balance-amount--muted">
                AED <?php echo e(number_format(isset($settings) ? $settings->min_withdrawal_amount : 50, 2)); ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-5">
            ...
            <div class="no-bank-warning">
                ...
                <a href="<?php echo e(route('referral.bank-accounts')); ?>" class="btn btn-gold btn-sm mt-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(url('/partner/withdraw')); ?>" id="withdrawForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="<?php echo e($account->id); ?>"
                                    <?php echo e(old('bank_account_id') == $account->id ? 'selected' : ($account->is_primary ? 'selected' : '')); ?>>
                                    <?php echo e($account->bank_name); ?> — •••• <?php echo e(substr($account->account_number, -4)); ?>

                                    <?php if($account->is_primary): ?> (Primary) <?php endif; ?>
                                </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    placeholder="0.00"
                                    step="0.01"
                                    min="<?php echo e(isset($settings) ? $settings->min_withdrawal_amount : 50); ?>"
                                    max="<?php echo e($availableBalance); ?>"
                                    required
                                >
                            </div>
                            <div class="amount-helper">
                                Available: <span class="amount-available" id="availableHint">AED <?php echo e(number_format($availableBalance, 2)); ?></span>
                                &nbsp;&middot;&nbsp;
                                <button type="button" class="max-btn" onclick="setMaxAmount(<?php echo e($availableBalance); ?>)">Withdraw Max</button>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <button
                            ...
                            <?php if($availableBalance <= 0): ?> disabled <?php endif; ?>
        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <?php if($withdrawalRequests->total() > 0): ?>
                    <span class="history-count"><?php echo e($withdrawalRequests->total()); ?> total</span>
                    <?php endif; ?>
                </div>

                <?php if($withdrawalRequests->isEmpty()): ?>
                ...
                <div class="table-responsive">
                    <table class="table table-dark table-hover mb-0 withdrawal-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div style="font-size: 0.78rem;"><?php echo e($request->created_at->format('d M Y')); ?></div>
                                    <div style="font-size: 0.68rem; color: var(--text-muted);"><?php echo e($request->created_at->format('H:i')); ?></div>
                                </td>
                                <td class="text-end">
                                    <span style="font-weight: 600; font-size: 0.85rem; color: var(--primary-gold);">
                                        AED <?php echo e(number_format($request->amount, 2)); ?>

                                    </span>
                                </td>
                                <td class="d-none d-md-table-cell">
                                    <?php if($request->bankAccount): ?>
                                    <div style="font-size: 0.78rem;"><?php echo e($request->bankAccount->bank_name); ?></div>
                                    <div style="font-size: 0.68rem; color: var(--text-muted); font-family: monospace;">
                                        •••• <?php echo e(substr($request->bankAccount->account_number, -4)); ?>
                                ...
                                <td class="text-center">
                                    ...
                                    ?>
                                    <span class="status-badge <?php echo e($s['class']); ?>"><?php echo e($s['label']); ?></span>
                                    <?php if($request->notes): ?>
                                    <div style="font-size: 0.65rem; color: var(--text-muted); margin-top: 2px; max-width: 100px;">
                                        <?php echo e(Str::limit($request->notes, 30)); ?>
                ...
                <?php if($withdrawalRequests->hasPages()): ?>
                <div class="card-body pt-2 pb-2">
                    <div class="pagination-wrap">
                        <?php echo e($withdrawalRequests->links()); ?>
...
<?php echo $__env->make('layouts.referral', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/referral/withdraw.blade.php ENDPATH**/ ?>
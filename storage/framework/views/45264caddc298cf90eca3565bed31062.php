...
<!-- Hero Slider -->
<?php if($detail && !empty($detail->activityImage)): ?>
<section class="hero-slider hero-style">
  <div class="swiper-container">
    <div class="swiper-wrapper">
        <?php $__currentLoopData = $activityImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="swiper-slide">
              <div class="slide-inner">
                <div class="overlay"></div>
                <img class="slide-img" src="<?php echo e(str_starts_with(trim($img), 'http') ? trim($img) : asset(trim($img))); ?>" alt="<?php echo e($activity->activityName); ?>">
                <div class="container text-center">
                  <div data-swiper-parallax="300" class="slide-title">
                    <h2><?php echo e($activity->activityName); ?></h2>
                  </div>
                  <div data-swiper-parallax="400" class="slide-text">
                    <p><?php echo e($activity->activityLocation); ?></p>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-8 pe-lg-5">
        <h1 class="fw-700 mb-4" style="color: #FFD23F; font-size: 48px; letter-spacing: 1px;"><?php echo e($activity->activityName); ?><span style="color: #fff;">.</span></h1>
        ...
        <?php if($detail && $detail->detailsIminfo): ?>
            <div class="mb-5">
                <h3 class="golden-heading-alt">Important Information</h3>
                <ul class="custom-list">
                    <?php $__currentLoopData = explode('#cseparator', $detail->detailsIminfo); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(trim($info) !== ''): ?>
        ...
        <!-- Highlights -->
        <?php if($detail && $detail->detailsHighlights): ?>
            <div class="mb-5">
                <h3 class="golden-heading-alt">Highlights</h3>
                <ul class="custom-list">
                    <?php $__currentLoopData = explode('#cseparator', $detail->detailsHighlights); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $highlight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="col-lg-4">
        <div class="sticky-top" style="top: 100px; z-index: 10;">
            <div class="booking-sidebar-card">
                ...
                <div class="main-price">AED <?php echo e(number_format($activity->activityPrice ?? 0, 2)); ?><span>/ Adult</span></div>
...
<?php if(session('success')): ?>
  <div class="classic-snackbar success show" id="sessionSnackbar"><?php echo e(session('success')); ?></div>
<?php endif; ?>
<?php if(session('error')): ?>
  <div class="classic-snackbar failed show" id="sessionSnackbar"><?php echo e(session('error')); ?></div>
<?php endif; ?>
<?php endif; ?>

<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/dubai-global-village.blade.php ENDPATH**/ ?>
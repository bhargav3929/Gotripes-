<script src="<?php echo e(asset('assets/index_files/swiper-bundle.min.js')); ?>"></script>
<script>
    ...
    <div class="row pt-5 pb-3">
      ...
      <div class="col-md-3 col-sm-6 mb-4">
        ...
        <ul class="list-unstyled">
          <?php if (\Illuminate\Support\Facades\Blade::check('feature', 'activities')): ?><li><a href="/activities" class="gt-footer-link">UAE Activities</a></li><?php endif; ?>
          <?php if (\Illuminate\Support\Facades\Blade::check('feature', 'tours')): ?><li><a href="/countriestour" class="gt-footer-link">Countries Tour</a></li><?php endif; ?>
      ...
      <div class="col-md-3 col-sm-6 mb-4">
        ...
        <ul class="list-unstyled">
          <?php if (\Illuminate\Support\Facades\Blade::check('feature', 'shop')): ?><li><a href="/shopnow" class="gt-footer-link">Shop Now</a></li><?php endif; ?>
          <?php if (\Illuminate\Support\Facades\Blade::check('feature', 'careers')): ?><li><a href="/lookingforajob" class="gt-footer-link">Looking for a Job</a></li><?php endif; ?>
          <?php if (\Illuminate\Support\Facades\Blade::check('feature', 'visas')): ?><li><a href="/visaservice" class="gt-footer-link">Visa Service</a></li><?php endif; ?>
          <?php if (\Illuminate\Support\Facades\Blade::check('feature', 'visas')): ?><li><a href="/uaevisa" class="gt-footer-link">UAE Visa</a></li><?php endif; ?>
        </ul>
      </div>
...
<script type="text/javascript" src="<?php echo e(asset('assets/index_files/jquery.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/index_files/vendors.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/index_files/main.js')); ?>"></script>
...
</html><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/footer.blade.php ENDPATH**/ ?>
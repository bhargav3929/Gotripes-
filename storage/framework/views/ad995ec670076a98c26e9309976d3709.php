...
<body>
    ...
    <div class="login-card">
        ...
        <form method="POST" action="<?php echo e(route('manager.login.submit')); ?>">
            <?php echo csrf_field(); ?>
    ...
    <div class="login-footer">
        <a href="<?php echo e(url('/')); ?>">Back to Go Trips</a>
    </div>
</body>
</html>
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/manager/login.blade.php ENDPATH**/ ?>
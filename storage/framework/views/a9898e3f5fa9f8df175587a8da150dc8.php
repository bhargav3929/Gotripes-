    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                <div>
                    <h1 class="h5 mb-1">Welcome back, <?php echo e($agent->name); ?>!</h1>
                    <p class="text-muted mb-0 small">Here's an overview of your referral performance</p>
                </div>
                <span class="badge bg-<?php echo e($agent->status === 'active' ? 'success' : 'secondary'); ?> px-3 py-2">
                    <i class="fas fa-circle me-1 small"></i><?php echo e(ucfirst($agent->status)); ?>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg-8 mb-3 mb-lg-0">
                        ...
                        <div class="d-flex gap-2">
                            <div class="referral-url flex-grow-1" id="referralUrl"><?php echo e($agent->referral_url); ?></div>
                            <button class="btn btn-gold copy-btn" data-copy="<?php echo e($agent->referral_url); ?>">
                        ...
                        <div class="d-flex flex-column align-items-lg-end">
                            ...
                            <span class="h5 mb-0" style="color: var(--primary-gold);">
                                <?php if($agent->commission_type === 'percentage'): ?>
                                    <?php echo e($agent->commission_value); ?>%
                                <?php else: ?>
                                    AED <?php echo e(number_format($agent->commission_value, 2)); ?>
        ...
        <div class="col-12">
            <div class="balance-widget">
                <div class="balance-widget-left">
                    ...
                    <div class="balance-widget-amount">AED <?php echo e(number_format($agent->availableBalance(), 2)); ?></div>
                    <?php if($pendingWithdrawal > 0): ?>
                    <div class="balance-widget-pending">
                        <i class="fas fa-clock me-1"></i>Pending withdrawal: AED <?php echo e(number_format($pendingWithdrawal, 2)); ?>

                    </div>
                    <?php endif; ?>
                </div>
                <div class="balance-widget-right">
                    <a href="<?php echo e(route('referral.withdraw')); ?>" class="btn btn-gold btn-sm withdraw-cta">
                        <i class="fas fa-paper-plane me-1"></i>Withdraw Now
                    </a>
                    <a href="<?php echo e(route('referral.bank-accounts')); ?>" class="btn-bank-link">
        ...
        <div class="col-6 col-lg-3">
            <div class="stat-card h-100">
                <div class="card-body">
                    ...
                    <h5 class="mb-0"><?php echo e(number_format($stats['total_clicks'])); ?></h5>
        ...
        <div class="col-6 col-lg-3">
            <div class="stat-card h-100">
                <div class="card-body">
                    ...
                    <h5 class="mb-0"><?php echo e(number_format($stats['total_sales'])); ?></h5>
        ...
        <div class="col-6 col-lg-3">
            <div class="stat-card h-100">
                <div class="card-body">
                    ...
                    <h5 class="mb-0 text-success">AED <?php echo e(number_format($stats['total_commission'], 2)); ?></h5>
        ...
        <div class="col-6 col-lg-3">
            <div class="stat-card h-100">
                <div class="card-body">
                    ...
                    <h5 class="mb-0"><?php echo e($stats['conversion_rate']); ?>%</h5>
                ...
                <div class="card-body">
                    <div class="mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="text-warning fw-semibold">AED <?php echo e(number_format($stats['pending_commission'], 2)); ?></span>
                        </div>
                        <div class="progress" style="height: 6px; background: var(--light-dark);">
                            ...
                            ?>
                            <div class="progress-bar bg-warning" style="width: <?php echo e($pendingPercent); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="text-info fw-semibold">AED <?php echo e(number_format($stats['total_commission'] - $stats['paid_commission'], 2)); ?></span>
                        </div>
                        <div class="progress" style="height: 6px; background: var(--light-dark);">
                            <?php
                                $approvedPercent = $total > 0 ? (($stats['total_commission'] - $stats['paid_commission']) / $total) * 100 : 0;
                            ?>
                            <div class="progress-bar bg-info" style="width: <?php echo e($approvedPercent); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="text-success fw-semibold">AED <?php echo e(number_format($stats['paid_commission'], 2)); ?></span>
                        </div>
                        <div class="progress" style="height: 6px; background: var(--light-dark);">
                            <?php
                                $paidPercent = $total > 0 ? ($stats['paid_commission'] / $total) * 100 : 0;
                            ?>
                            <div class="progress-bar bg-success" style="width: <?php echo e($paidPercent); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h5 class="mb-0" style="color: var(--primary-gold);">AED <?php echo e(number_format($stats['total_commission'], 2)); ?></h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('referral.orders')); ?>" class="btn btn-sm btn-outline-gold">View All</a>
                </div>
                        ...
                        <table class="table table-dark table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end text-success fw-semibold">AED <?php echo e(number_format($order->commission_amount, 2)); ?></td>
...
<?php echo $__env->make('layouts.referral', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/referral/dashboard.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'My Earnings'); ?>
        ...
        <div class="col-12">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                ...
                <div class="btn-group" role="group">
                    <a href="<?php echo e(route('referral.earnings', ['period' => 'week'])); ?>"
                       class="btn btn-xs <?php echo e($period == 'week' ? 'btn-gold' : 'btn-outline-gold'); ?>">Week</a>
                    <a href="<?php echo e(route('referral.earnings', ['period' => 'month'])); ?>"
                       class="btn btn-xs <?php echo e($period == 'month' ? 'btn-gold' : 'btn-outline-gold'); ?>">Month</a>
                    <a href="<?php echo e(route('referral.earnings', ['period' => 'year'])); ?>"
                       class="btn btn-xs <?php echo e($period == 'year' ? 'btn-gold' : 'btn-outline-gold'); ?>">Year</a>
                    <a href="<?php echo e(route('referral.earnings', ['period' => 'all'])); ?>"
                       class="btn btn-xs <?php echo e($period == 'all' ? 'btn-gold' : 'btn-outline-gold'); ?>">All Time</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-4">
            <div class="card earnings-card pending">
                <div class="card-body text-center py-3">
                    ...
                    <div class="earnings-value warning">AED <?php echo e(number_format($earningsByStatus['pending'], 2)); ?></div>
        ...
        <div class="col-4">
            <div class="card earnings-card approved">
                <div class="card-body text-center py-3">
                    ...
                    <div class="earnings-value info">AED <?php echo e(number_format($earningsByStatus['approved'], 2)); ?></div>
        ...
        <div class="col-4">
            <div class="card earnings-card paid">
                <div class="card-body text-center py-3">
                    ...
                    <div class="earnings-value success">AED <?php echo e(number_format($earningsByStatus['paid'], 2)); ?></div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-5 text-center text-md-start mb-2 mb-md-0">
                            ...
                            <h4 class="mb-0" style="color: var(--primary-gold);">
                                AED <?php echo e(number_format($earningsByStatus['pending'] + $earningsByStatus['approved'] + $earningsByStatus['paid'], 2)); ?>
                        ...
                        <div class="col-md-7">
                            <div class="row text-center">
                                <div class="col-4">
                                    <div class="stat-num"><?php echo e(number_format($stats['total_orders'])); ?></div>
                                    <small class="text-muted">Orders</small>
                                </div>
                                <div class="col-4">
                                    <div class="stat-num"><?php echo e(number_format($stats['total_clicks'])); ?></div>
                                    <small class="text-muted">Clicks</small>
                                </div>
                                <div class="col-4">
                                    <div class="stat-num"><?php echo e($stats['conversion_rate']); ?>%</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const monthlyEarnings = <?php echo json_encode($monthlyEarnings, 15, 512) ?>;
...
<?php echo $__env->make('layouts.referral', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Pragathi\Desktop\GoTrips-Complete\resources\views/referral/earnings.blade.php ENDPATH**/ ?>
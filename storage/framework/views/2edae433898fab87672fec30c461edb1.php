...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">
                Dear <strong><?php echo e($supplierName); ?></strong>,<br>
            ...
            <div class="activity-card">
                ...
                <p style="margin-top: 10px;"><span class="icon">🔖</span>Booking Ref: <strong>ORDAB<?php echo e($booking['id'] ?? 'N/A'); ?></strong></p>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="detail-row">
                    ...
                    <span class="value"><?php echo e(\Carbon\Carbon::parse($booking['createDate'] ?? now())->format('M j, Y g:i A')); ?></span>
                </div>
            </div>
        ...
        <div class="footer">
            ...
            <p style="font-size: 11px; opacity: 0.7; margin-top: 10px;">
                For support, contact the GoTrips team at <?php echo e(config('mail.from.address')); ?>
...
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/emails/supplier_booking.blade.php ENDPATH**/ ?>
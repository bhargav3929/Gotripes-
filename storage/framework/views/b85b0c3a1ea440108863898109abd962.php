 ...
 <div class="col-md-3 mt-5">
            <div class="input-group " >
                <div style="width: 100px;">
                 <a href="<?php echo e(route('admin.appointments.index')); ?>" class="btn btn-primary btn-sm shadow-sm "><?php echo e(__('❮  Go Back')); ?></a>
                </div>
                    ...
                    <div class="input-group-append">
                        ...
                        <select type="text" id="searchInput1" class="form-control" >
                            ...
                            <?php $__currentLoopData = $conventions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $convention): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option > <?php echo e($convention); ?></option>
...
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/schedule/index.blade.php ENDPATH**/ ?>
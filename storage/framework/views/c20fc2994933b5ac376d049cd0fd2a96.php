        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800"><?php echo e(__('Edit Position')); ?></h1>
                    <a href="<?php echo e(route('admin.positions.index')); ?>" class="btn btn-primary btn-sm shadow-sm"><?php echo e(__('Go Back')); ?></a>
                </div>
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('admin.positions.update', $position->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('put'); ?>
                    <div class="form-group">
                    <label for="Convention_Id"><?php echo e(__('Convention')); ?></label>
                    <select class="form-control" id="country-dropdown" name="Convention_Id">
                        ...
                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" <?php if($country->id == $position->Convention_Id): ?> selected <?php endif; ?>><?php echo e($country->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
<div class="form-group">
    <label for="hall_id"><?php echo e(__('Hall')); ?></label>
    <select class="form-control" id="state-dropdown" name="hall_id">
        <option value="<?php echo e($position->hall_id); ?>" selected><?php echo e($position->hall->name); ?></option>
        <!-- You can populate Hall options dynamically here if needed -->
                     ...
                     <div class="form-group">
                    <label for="name"><?php echo e(__('Position')); ?></label>
                    <input type="text" class="form-control" id="name" name="name" value="<?php echo e($position->name); ?>" />
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/positions/edit.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Edit Travel Package'); ?>

<?php $__env->startSection('page-title', 'Edit Travel Package'); ?>
            ...
            <div class="card shadow-lg border-0 animate-fade-in">
                <div class="card-header">
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3">
                        <h3 class="card-title">
                            <i class="fas fa-suitcase-rolling me-2"></i>Edit Travel Package
                        </h3>
                ...
                <form method="POST" action="<?php echo e(route('admin.packages.update', $package->id)); ?>" enctype="multipart/form-data" id="packageForm">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-stretch align-items-sm-center gap-2">
                            <div class="text-light-muted order-2 order-sm-1 text-center text-sm-start">
                                <small>
                                    ...
                                    Last modified: <?php echo e($package->modifiedDate ? \Carbon\Carbon::parse($package->modifiedDate)->format('M d, Y H:i') : 'Never'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function() {
        ...
        setTimeout(() => {
            submitBtn.innerHTML = '<i class="fas fa-save me-1"></i> Update Package';
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/packages/edit.blade.php ENDPATH**/ ?>
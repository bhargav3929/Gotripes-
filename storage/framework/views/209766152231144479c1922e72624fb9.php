    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body pt-4 px-4">
                ...
                <h5 class="text-center mb-3" id="activityBookingModalLabel" style="color: #fff; font-size: 24px; font-weight: 900; text-transform: uppercase; letter-spacing: -0.5px;">
                    ...
                    <div class="booking-columns">
                        ...
                        <div class="booking-section-group">
                            <div class="section-header mb-2">
                                <h6 class="text-uppercase fw-bold m-0" style="color: #FFD23F; letter-spacing: 2px; font-size: 10px;">Primary Contact Information</h6>
                            </div>
                            <div class="row g-2">
                                <div class="col-12">
                        ...
                        <!-- Right: Trip Customization -->
                        <div class="booking-section-group">
                            <div class="section-header mb-2">
                                <h6 class="text-uppercase fw-bold m-0" style="color: #FFD23F; letter-spacing: 2px; font-size: 10px;">Trip Customization</h6>
                            </div>
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <div class="input-group-premium">
                                ...
                                <div class="col-12">
                                    <div class="input-group-premium align-items-start py-1">
                                        <i class="bi bi-chat-left-text text-warning mt-1"></i>
                                        <textarea name="remarks" class="form-control-premium border-0 p-0 ms-2" rows="1" placeholder="Special requests or notes..." style="background: transparent; min-height: 40px;"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="booking-bottom-bar">
                        <div id="modalPriceSummary" class="price-summary-inline" style="display: none;">
                            <div class="summary-inline-items">
                                <span class="summary-inline-item">Adults: <strong id="modalDisplayAdultPrice">0.00 AED</strong></span>
                                <span class="summary-inline-sep">|</span>
                                <span class="summary-inline-item">Children: <strong id="modalDisplayChildPrice">0.00 AED</strong></span>
                                <span class="summary-inline-sep" id="modalDisplayTransportRow" style="display: none !important;">|</span>
                                <span class="summary-inline-item" id="modalDisplayTransportWrap" style="display: none !important;">Transport: <strong id="modalDisplayTransportPrice">0.00 AED</strong></span>
                                <span class="summary-inline-sep" id="modalDisplayVatRow" style="display: none !important;">|</span>
                                <span class="summary-inline-item" id="modalDisplayVatWrap" style="display: none !important;">VAT: <strong id="modalDisplayVatPrice">0.00 AED</strong></span>
                            </div>
                            <div class="summary-inline-total">
                                Total: <strong id="modalDisplayTotalPrice">0.00 AED</strong>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateTotal() {
        ...
        const transWrap = document.getElementById('modalDisplayTransportWrap');
        if(transportPrice > 0) {
            if(transRow) transRow.style.setProperty('display', 'inline', 'important');
            if(transWrap) transWrap.style.setProperty('display', 'inline', 'important');
            document.getElementById('modalDisplayTransportPrice').textContent = `${transportPrice.toFixed(2)} AED`;
        } else {
            if(transRow) transRow.style.setProperty('display', 'none', 'important');
            if(transWrap) transWrap.style.setProperty('display', 'none', 'important');
        }

        const vatRow = document.getElementById('modalDisplayVatRow');
        const vatWrap = document.getElementById('modalDisplayVatWrap');
        if(vatRow) {
            vatRow.style.setProperty('display', 'inline', 'important');
            if(vatWrap) vatWrap.style.setProperty('display', 'inline', 'important');
...
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/partials/activity_booking_modal.blade.php ENDPATH**/ ?>
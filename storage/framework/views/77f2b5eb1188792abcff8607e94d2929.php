...
<head>
    <meta charset="utf-8">
    <title>Activity Booking <?php echo e($isAdmin ? 'Request' : 'Confirmation'); ?></title>
    <style>
        body {
        ...
        .highlight-box {
            background: <?php echo e($isAdmin ? 'linear-gradient(135deg, #e3f2fd 0%, #f3e5f5 100%)' : 'linear-gradient(135deg, #fff8e1 0%, #ffecb3 100%)'); ?>;
            border: 2px solid <?php echo e($isAdmin ? '#2196f3' : '#FFD23F'); ?>;
            padding: 20px;
            border-radius: 12px;
            margin: 25px 0;
            box-shadow: 0 4px 15px <?php echo e($isAdmin ? 'rgba(33, 150, 243, 0.2)' : 'rgba(255, 210, 63, 0.3)'); ?>;
            position: relative;
        }
        .highlight-box::before {
            ...
            width: 4px;
            height: 100%;
            background: <?php echo e($isAdmin ? '#2196f3' : '#FFD23F'); ?>;
            border-radius: 0 0 0 10px;
        }
        .status-badge {
            display: inline-block;
            padding: 8px 16px;
            background: <?php echo e($isAdmin ? 'linear-gradient(135deg, #2196f3 0%, #1976d2 100%)' : 'linear-gradient(135deg, #FFD23F 0%, #ffc107 100%)'); ?>;
            color: <?php echo e($isAdmin ? 'white' : '#1a1a1a'); ?>;
            border-radius: 25px;
            font-size: 12px;
            font-weight: bold;
            text-transform: uppercase;
            letter-spacing: 1px;
            box-shadow: 0 4px 15px <?php echo e($isAdmin ? 'rgba(33, 150, 243, 0.4)' : 'rgba(255, 210, 63, 0.4)'); ?>;
        }
        .footer {
            background: linear-gradient(135deg, #000000 0%, #1a1a1a 50%, #000000 100%);
            color: #FFD23F;
...
<body>
    <div class="container">
        <div class="header">
            <h1><span class="icon">🎫</span>Activity Booking <?php echo e($isAdmin ? 'Request' : 'Confirmation'); ?></h1>
            <p style="margin: 15px 0 0 0;">
                <span class="status-badge"><?php echo e($isAdmin ? 'New Request' : 'Confirmed'); ?></span>
            </p>
        </div>
        ...
        <div class="content">
            ...
            <div class="activity-info">
                <h2><?php echo e($booking['activityName'] ?? 'Activity Booking'); ?></h2>
                <p><span class="icon">📍</span><?php echo e($booking['activityLocation'] ?? 'Location TBA'); ?></p>
                <p><span class="icon">📅</span><?php echo e(\Carbon\Carbon::parse($booking['date'])->format('l, F j, Y')); ?></p>
                <p style="margin-top: 10px;"><span class="icon">🔖</span>Order ID: <strong>ORDAB<?php echo e($booking['id'] ?? 'N/A'); ?></strong></p>
            </div>
            ...
            <div class="booking-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="value"><?php echo e($booking['name']); ?></span>
                </div>
                
                <div class="detail-row">
                    <span class="label"><span class="icon">📧</span>Email:</span>
                    <span class="value"><?php echo e($booking['email']); ?></span>
                </div>
                
                <div class="detail-row">
                    <span class="label"><span class="icon">📞</span>Phone:</span>
                    <span class="value"><?php echo e($booking['phone']); ?></span>
                </div>
                
                <div class="detail-row">
                    <span class="label"><span class="icon">🏠</span>Address:</span>
                    <span class="value"><?php echo e($booking['address']); ?></span>
                </div>
                
                <div class="detail-row">
                    <span class="label"><span class="icon">🌍</span>Nationality:</span>
                    <span class="value"><?php echo e($booking['nationality']); ?></span>
                </div>
            </div>
            ...
            <div class="booking-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="value"><?php echo e($booking['adults']); ?> person(s)</span>
                </div>
                
                <div class="detail-row">
                    <span class="label"><span class="icon">👶</span>Children:</span>
                    <span class="value"><?php echo e($booking['childrens']); ?> person(s)</span>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <span class="value">
                        <?php if($booking['paymentOption'] == 'book_with_us'): ?>
                ...
                <div class="detail-row">
                    ...
                    <span class="value"><?php echo e($booking['remarks']); ?></span>
                </div>
                <?php endif; ?>
            </div>

            <?php if(!empty($booking['supplierName'])): ?>
            <div class="booking-details">
                <h3 class="section-header">
                ...
                <div class="detail-row">
                    <span class="label"><span class="icon">🏢</span>Name:</span>
                    <span class="value"><?php echo e($booking['supplierName']); ?></span>
                </div>
                <?php if(!empty($booking['supplierEmail'])): ?>
                <div class="detail-row">
                    <span class="label"><span class="icon">📧</span>Email:</span>
                    <span class="value"><?php echo e($booking['supplierEmail']); ?></span>
                </div>
                <?php endif; ?>
            </div>
            <?php endif; ?>
            ...
            <div class="booking-details">
                ...
                <div style="text-align: center;">
                    <div class="amount-highlight">
                        <span class="icon">💰</span>Total Amount: <?php echo e($booking['amount']); ?> <?php echo e($booking['currency']); ?>
                ...
                <div class="detail-row">
                    ...
                    <span class="value"><?php echo e(\Carbon\Carbon::parse($booking['createDate'])->format('M j, Y g:i A')); ?></span>
                </div>
            </div>
        ...
        <div class="footer">
            ...
            <p style="font-size: 13px; color: #e0e0e0; margin-top: 5px;">
                📧 Email: <?php echo e(config('mail.from.address')); ?><br>
...
<?php /**PATH C:\Users\Pragathi\Desktop\GoTrips-Complete\resources\views/emails/activity_booking.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Hero Ad TVs'); ?>
<?php $__env->startSection('page-title', 'Hero Ad TVs'); ?>

<?php $__env->startSection('content'); ?>
<div class="wp-page-header">
    <h1 class="wp-page-title">Hero Ad TVs</h1>
    <a href="<?php echo e(route('manager.adslots.create')); ?>" class="wp-btn wp-btn-primary">
...
<div class="wp-notice wp-notice-info" style="border-left-color: var(--wp-primary);">
    <span>
        ...
        <strong><?php echo e($usedSlots ?? 0); ?></strong> of 5 TVs active with <strong><?php echo e($totalMedia ?? 0); ?></strong> total media items.
...
<?php if(session('success')): ?>
    <div class="wp-notice wp-notice-success" style="border-left-color: #28a745; background: rgba(40,167,69,0.1);">
        <span><i class="fas fa-check-circle me-1" style="color: #5cbf70;"></i> <?php echo e(session('success')); ?></span>
    </div>
<?php endif; ?>


<?php for($tv = 1; $tv <= 5; $tv++): ?>
    <?php $mediaItems = isset($adSlots[$tv]) ? $adSlots[$tv] : collect(); ?>
    <div class="wp-card" style="margin-bottom: 20px;">
        <div class="wp-card-header" style="display: flex; justify-content: space-between; align-items: center;">
            <div style="display: flex; align-items: center; gap: 10px;">
                <span class="wp-badge wp-badge-blue" style="font-size: 14px; padding: 6px 12px; border-radius: 8px;">TV <?php echo e($tv); ?></span>
                <span style="font-size: 12px; color: var(--wp-text-muted);">
                    <?php echo e($mediaItems->count()); ?> media item<?php echo e($mediaItems->count() !== 1 ? 's' : ''); ?>

                </span>
            </div>
            <a href="<?php echo e(route('manager.adslots.create')); ?>?tv=<?php echo e($tv); ?>" class="wp-btn wp-btn-secondary wp-btn-sm">
        ...
        <div class="wp-card-body">
                    ...
                    <?php $__currentLoopData = $mediaItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div style="width: 160px; border: 1px solid var(--wp-border-light); border-radius: 6px; overflow: hidden; background: #1a1a1a;">
                            <div style="position: relative; height: 90px; overflow: hidden; background: #111;">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo e(asset($media->imgPath)); ?>" alt="Slot <?php echo e($tv); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                            ...
                            <div style="padding: 8px; display: flex; justify-content: space-between; align-items: center;">
                                <span style="font-size: 11px; color: var(--wp-text-muted);">
                                    ...
                                    <?php else: ?>
                                        <i class="fas fa-clock"></i> <?php echo e($media->duration ?? 5); ?>s
                                    <?php endif; ?>
                                </span>
                                <div style="display: flex; gap: 4px;">
                                    <a href="<?php echo e(route('manager.adslots.edit', $media->id)); ?>" class="wp-btn wp-btn-secondary wp-btn-sm" style="padding: 2px 8px; font-size: 11px;" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form action="<?php echo e(route('manager.adslots.destroy', $media->id)); ?>" method="POST" onsubmit="return confirm('Remove this media from TV <?php echo e($tv); ?>?');">
            ...
            <?php else: ?>
                <div style="text-align: center; padding: 20px 0; color: var(--wp-text-muted);">
                    ...
                    <a href="<?php echo e(route('manager.adslots.create')); ?>?tv=<?php echo e($tv); ?>" style="color: var(--wp-primary);">Add media.</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/manager/adslots/index.blade.php ENDPATH**/ ?>
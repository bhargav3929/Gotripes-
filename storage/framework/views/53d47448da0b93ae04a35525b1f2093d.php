...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Manager Panel'); ?> - Go Trips</title>
...
<body>
    ...
    <div style="display: flex; min-height: 100vh;">
        ...
        <nav class="wp-sidebar" id="managerSidebar">
            <a class="sidebar-brand" href="<?php echo e(route('manager.dashboard')); ?>">
                <img src="<?php echo e(asset('assets/index_files/logo.png')); ?>" alt="Logo" class="sidebar-brand-logo">
                <span class="sidebar-brand-text">Go Trips</span>
            </a>

            <ul class="wp-nav">
                <li class="wp-nav-item">
                    <a href="<?php echo e(route('manager.dashboard')); ?>" class="<?php echo e(request()->routeIs('manager.dashboard') ? 'active' : ''); ?>">
                ...
                <li class="wp-nav-item">
                    <a href="<?php echo e(route('manager.adslots.index')); ?>" class="<?php echo e(request()->routeIs('manager.adslots.*') ? 'active' : ''); ?>">
                        <i class="fas fa-photo-video"></i>
                        <span>Hero Ad Slots</span>
                    </a>
                </li>
                <li class="wp-nav-item">
                    <a href="<?php echo e(route('manager.announcements.index')); ?>" class="<?php echo e(request()->routeIs('manager.announcements.*') ? 'active' : ''); ?>">
                        <i class="fas fa-rss"></i>
                        <span>News Ticker</span>
                    </a>
                </li>
                <li class="wp-nav-item">
                    <a href="<?php echo e(route('manager.activities.index')); ?>" class="<?php echo e(request()->routeIs('manager.activities.*') ? 'active' : ''); ?>">
                ...
                <li class="wp-nav-item">
                    <a href="<?php echo e(route('manager.settings.features')); ?>" class="<?php echo e(request()->routeIs('manager.settings.*') ? 'active' : ''); ?>">
                ...
                <li class="wp-nav-item">
                    <form action="<?php echo e(route('manager.logout')); ?>" method="POST" style="margin:0;">
                        <?php echo csrf_field(); ?>
                        <button type="submit">
        ...
        <div id="content-wrapper">
            ...
            <header class="wp-topbar">
                ...
                <div class="topbar-user">
                    <span class="d-none d-sm-inline"><?php echo e(session('manager_name', 'Manager')); ?></span>
                    <div class="topbar-user-avatar">
                        <?php echo e(strtoupper(substr(session('manager_name', 'M'), 0, 1))); ?>
...
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/layouts/manager.blade.php ENDPATH**/ ?>
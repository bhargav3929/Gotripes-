            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="service-card">
                        <a href="<?php echo e($service['link']); ?>" class="service-card-link">
                            <div class="service-card-image-wrapper">
                                <img src="<?php echo e(asset($service['img'])); ?>" alt="<?php echo e($service['title']); ?>" class="service-card-img">
                                <div class="service-card-overlay"></div>
                            </div>
                            <div class="service-card-content">
                                <h3 class="service-card-title"><?php echo e($service['title']); ?></h3>
                            </div>
                        </a>
                    </div>
                </div>
...
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/our-services.blade.php ENDPATH**/ ?>
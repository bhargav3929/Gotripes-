<?php $__env->startSection('title', 'Manage Umrah Packages'); ?>

<?php $__env->startSection('page-title', 'Manage Umrah Packages'); ?>
        ...
        <div class="col-12">
            <div class="card shadow-lg border-0 animate-fade-in">
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3">
                        ...
                        <div class="card-tools d-flex align-items-center gap-2">
                            ...
                            <span class="umrah-count-badge">
                                <i class="fas fa-box me-1"></i><?php echo e($packages->total()); ?> <?php echo e(Str::plural('Package', $packages->total())); ?>

                            </span>
                            <?php endif; ?>
                            <a href="<?php echo e(route('admin.umrah-packages.create')); ?>"
                ...
                <div class="card-body p-2 p-sm-3 p-md-4">
                    ...
                    <!-- Package Row Card -->
                    <div class="umrah-pkg-row animate-fade-in" style="animation-delay: <?php echo e($index * 0.05); ?>s;">
                        <div class="umrah-pkg-rank">
                            <span class="umrah-rank-num"><?php echo e($packages->firstItem() + $index); ?></span>
                        </div>

                        <div class="umrah-pkg-img-wrap">
                            <?php if($package->image): ?>
                            <img src="<?php echo e(asset($package->image)); ?>" alt="<?php echo e($package->title); ?>" class="umrah-pkg-img">
                            <?php else: ?>
                        ...
                        <div class="umrah-pkg-info">
                            <div class="umrah-pkg-title-row">
                                <h5 class="umrah-pkg-title"><?php echo e($package->title); ?></h5>
                                <div class="umrah-pkg-badges">
                                    <?php if($package->tag): ?>
                                    <span class="umrah-tag-badge umrah-tag-<?php echo e(strtolower(str_replace(' ', '-', $package->tag))); ?>"><?php echo e($package->tag); ?></span>
                                    <?php endif; ?>
                                    <span class="umrah-duration-badge">
                                        <i class="fas fa-clock me-1"></i><?php echo e($package->duration); ?>

                                    </span>
                                </div>
                            </div>
                            <p class="umrah-pkg-desc"><?php echo e(Str::limit($package->description, 100)); ?></p>
                            ...
                            <div class="umrah-pkg-features">
                                ...
                                <span class="umrah-feature-more">+<?php echo e(count($package->features) - 4); ?> more</span>
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="umrah-pkg-price-col">
                            <div class="umrah-pkg-currency"><?php echo e($package->currency); ?></div>
                            <div class="umrah-pkg-price"><?php echo e(number_format($package->price, 0)); ?></div>
                            <div class="umrah-pkg-order">Order: <?php echo e($package->sortOrder); ?></div>
                        </div>

                        <div class="umrah-pkg-actions">
                            <a href="<?php echo e(route('admin.umrah-packages.edit', $package->id)); ?>"
                            ...
                            <button type="button"
                                    ...
                                    data-package-title="<?php echo e(Str::limit($package->title, 40)); ?>"
                    ...
                    <div class="umrah-empty-state">
                        ...
                        <a href="<?php echo e(route('admin.umrah-packages.create')); ?>" class="umrah-empty-btn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        if (currentPackageId) {
            ...
            deleteForm.action = `<?php echo e(route('admin.umrah-packages.index')); ?>/${currentPackageId}`;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/umrah-packages/index.blade.php ENDPATH**/ ?>
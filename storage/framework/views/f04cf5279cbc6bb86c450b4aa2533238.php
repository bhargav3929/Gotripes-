...
<body>
    ...
    <div class="login-container">
        <div class="login-header">
            <img src="<?php echo e(asset('assets/index_files/logo.png')); ?>" alt="GoTrips" style="height:48px;width:auto;margin-bottom:0.5rem;">
        ...
        <div class="login-card">
            ...
            <form method="POST" action="<?php echo e(route('referral.login.submit')); ?>">
                <?php echo csrf_field(); ?>
        ...
        <div class="login-footer">
            <p class="text-muted mb-2">
                Not a partner yet?
                <a href="<?php echo e(url('/')); ?>">Visit GoTrips.ai</a>
            </p>
...
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/referral/auth/login.blade.php ENDPATH**/ ?>
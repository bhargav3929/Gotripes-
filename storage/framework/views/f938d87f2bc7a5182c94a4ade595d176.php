...
<?php $__env->startSection('page-title', 'Hero Ad TVs'); ?>

<?php $__env->startSection('content'); ?>
<div class="wp-page-header">
    <h1 class="wp-page-title">Edit Media in TV <?php echo e($homepagead->slotOrder); ?></h1>
    <a href="<?php echo e(route('manager.adslots.index')); ?>" class="wp-btn wp-btn-secondary">
...
<div class="row">
    <div class="col-lg-8">
        <form action="<?php echo e(route('manager.adslots.update', $homepagead->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="wp-card">
                ...
                <div class="wp-card-body" style="text-align: center; background: #1a1a1a;">
                    <?php if($homepagead->mediaType === 'video'): ?>
                    ...
                    <?php else: ?>
                        <img src="<?php echo e(asset($homepagead->imgPath)); ?>" alt="Current" style="max-width: 100%; max-height: 280px; border-radius: 4px;">
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="wp-card-body">
                    <div class="wp-form-group">
                        ...
                        <select class="wp-select" id="slotOrder" name="slotOrder" required style="max-width: 200px;">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e($homepagead->slotOrder == $i ? 'selected' : ''); ?>>TV <?php echo e($i); ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                    ...
                    <div class="wp-form-group">
                        ...
                        <div style="display: flex; gap: 16px;">
                            <label style="display: flex; align-items: center; gap: 6px; cursor: pointer; font-size: 13px;">
                                <input type="radio" name="mediaType" value="image" <?php echo e(($homepagead->mediaType ?? 'image') === 'image' ? 'checked' : ''); ?> style="accent-color: var(--wp-primary);">
                                <i class="fas fa-image" style="color: var(--wp-text-muted);"></i> Image
                            </label>
                            <label style="display: flex; align-items: center; gap: 6px; cursor: pointer; font-size: 13px;">
                                <input type="radio" name="mediaType" value="video" <?php echo e(($homepagead->mediaType ?? 'image') === 'video' ? 'checked' : ''); ?> style="accent-color: var(--wp-primary);">
                                <i class="fas fa-video" style="color: var(--wp-text-muted);"></i> Video
                            </label>
                        </div>
                    </div>

                    <div class="wp-form-group" id="durationGroup" style="<?php echo e(($homepagead->mediaType ?? 'image') === 'video' ? 'display:none;' : ''); ?>">
                        <label for="duration" class="wp-form-label">Display Duration</label>
                        <div style="display: flex; align-items: center; gap: 8px;">
                            <input type="number" class="wp-input" id="duration" name="duration" value="<?php echo e($homepagead->duration ?? 5); ?>" min="1" max="60" style="max-width: 100px;">
    ...
    <div class="col-lg-4">
        <div class="wp-card">
            ...
            <div class="wp-card-body" style="font-size: 12px; color: var(--wp-text-secondary); line-height: 1.8;">
                ...
                <p style="margin-bottom: 6px;"><strong>TV Slot:</strong> <?php echo e($homepagead->slotOrder); ?></p>
                <p style="margin-bottom: 6px;"><strong>Display Order:</strong> #<?php echo e($homepagead->displayOrder); ?></p>
                <p style="margin-bottom: 6px;"><strong>Duration:</strong> <?php echo e($homepagead->duration ?? 5); ?>s</p>
                <p style="margin-bottom: 6px;"><strong>Created by:</strong> <?php echo e($homepagead->createdby ?? 'Unknown'); ?></p>
                <?php if($homepagead->modifiedby): ?>
                    <p style="margin-bottom: 0;"><strong>Last modified by:</strong> <?php echo e($homepagead->modifiedby); ?></p>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/manager/adslots/edit.blade.php ENDPATH**/ ?>
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-xl-10">
            ...
            <div class="card shadow-lg border-0 animate-fade-in">
                ...
                <!-- Responsive Form -->
                <form method="POST" action="<?php echo e(route('admin.announcements.update', $announcement->id)); ?>" enctype="multipart/form-data" id="announcementForm">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="row g-2 g-sm-3 g-md-4">
                            ...
                            <div class="col-12 col-lg-8">
                                ...
                                <div class="mb-3 mb-md-4">
                                    ...
                                    <input type="text" 
                                           class="form-control form-control-mobile <?php $__errorArgs = ['description'];
...
unset($__errorArgs, $__bag); ?>" 
                                           id="description" 
                                           name="description" 
                                           value="<?php echo e(old('description', $announcement->description)); ?>" 
                            ...
                            <div class="col-12 col-lg-8">
                                <div class="mb-3 mb-md-4">
                                    ...
                                    <select class="form-control form-control-mobile" id="tagType" name="tagType">
                                        ...
                                        <option value="breaking" <?php echo e(old('tagType', $announcement->tagType) == 'breaking' ? 'selected' : ''); ?>>BREAKING (Red)</option>
                                        <option value="trending" <?php echo e(old('tagType', $announcement->tagType) == 'trending' ? 'selected' : ''); ?>>TRENDING (Gold)</option>
                                        <option value="exclusive" <?php echo e(old('tagType', $announcement->tagType) == 'exclusive' ? 'selected' : ''); ?>>EXCLUSIVE (Green)</option>
                                        <option value="alert" <?php echo e(old('tagType', $announcement->tagType) == 'alert' ? 'selected' : ''); ?>>NEW / ALERT (Blue)</option>
                                        <option value="hot" <?php echo e(old('tagType', $announcement->tagType) == 'hot' ? 'selected' : ''); ?>>HOT (Yellow)</option>
                                    </select>
                                    <div class="form-text text-light-muted">
                                            ...
                                            <div class="card-body p-2 p-sm-3">
                                                ...
                                                <div class="form-check form-switch mb-2 mb-sm-3">
                                                    <input class="form-check-input mobile-switch" 
                                                           ...
                                                           value="1"
                                                           <?php echo e(old('announcementImportance', $announcement->AnnouncementImportance) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label fw-medium text-white ms-2 fs-7 fs-sm-6" for="announcementImportance">
                                                        <span class="badge <?php echo e($announcement->AnnouncementImportance ? 'bg-success' : 'bg-warning'); ?> text-<?php echo e($announcement->AnnouncementImportance ? 'white' : 'dark'); ?> me-1 me-sm-2">
                                                            <i class="fas fa-<?php echo e($announcement->AnnouncementImportance ? 'star' : 'badge-check'); ?>"></i>
                                                        </span>
                                                        <span class="d-none d-sm-inline">Mark as <strong><?php echo e($announcement->AnnouncementImportance ? 'New ✓' : 'New'); ?></strong></span>
                                                        <span class="d-sm-none"><strong><?php echo e($announcement->AnnouncementImportance ? 'New ✓' : 'New'); ?></strong></span>
                                                    </label>
                                                </div>
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-12">
                                        <div class="card bg-light-dark border-gold mb-2 mb-lg-0">
                                            <div class="card-body p-2 p-sm-3">
                                                ...
                                                <!-- Current SVG Display -->
                                                <?php if($announcement->flagImgPath): ?>
                                                <div class="current-flag mb-2 mb-sm-3">
                                                    ...
                                                    <div class="border border-gold rounded p-2 bg-dark text-center">
                                                        <div class="current-svg-preview">
                                                            <?php if(file_exists(public_path($announcement->flagImgPath))): ?>
                                                                <?php echo file_get_contents(public_path($announcement->flagImgPath)); ?>
                                                ...
                                                <div class="mb-2 mb-sm-3">
                                                    <label for="flagPath" class="form-label fw-medium text-white fs-7 fs-sm-6">
                                                        <?php echo e($announcement->flagImgPath ? 'Replace SVG Flag' : 'Upload SVG Flag'); ?>

                                                    </label>
                                                    <input type="file" 
                                                           class="form-control form-control-mobile <?php $__errorArgs = ['flagPath'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/announcements/edit.blade.php ENDPATH**/ ?>
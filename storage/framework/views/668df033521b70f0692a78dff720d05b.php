      ...
      <div class="flight-search-box">
        ...
        <div class="row g-3 mb-1 align-items-end">
          ...
          <div class="col-6 col-md-2">
            <label>Depart</label>
            <input type="month" class="form-control" id="flight-departure_at" value="<?php echo e(date('Y-m')); ?>">
          </div>
          <div class="col-6 col-md-2" id="flight-return-date-box">
            <label>Return</label>
            <input type="month" class="form-control" id="flight-return_at" value="<?php echo e(date('Y-m')); ?>">
          </div>
...
</div><?php /**PATH C:\Users\Pragathi\Desktop\GoTrips-Complete\resources\views/banner1.blade.php ENDPATH**/ ?>
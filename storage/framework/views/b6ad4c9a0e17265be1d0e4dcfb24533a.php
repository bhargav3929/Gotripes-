...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center gap-2" href="<?php echo e(route('referral.dashboard')); ?>">
                <img src="<?php echo e(asset('assets/index_files/logo.png')); ?>" alt="GoTrips" style="height:36px;width:auto;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom <?php echo e(request()->routeIs('referral.withdraw') ? 'active' : ''); ?>"
                           href="<?php echo e(route('referral.withdraw')); ?>">
                            <i class="fas fa-wallet me-1"></i> Withdraw
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom <?php echo e(request()->routeIs('referral.bank-accounts') ? 'active' : ''); ?>"
                           href="<?php echo e(route('referral.bank-accounts')); ?>">
...
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/layouts/referral.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Manage UAE Activities'); ?>

<?php $__env->startSection('page-title', 'Manage UAE Activities'); ?>
...
<div class="page-wrap">
    ...
    <div class="top-bar">
        ...
        <a href="<?php echo e(route('admin.uaeactivities.create')); ?>" class="btn-add">
    ...
    <div class="partner-info">
        ...
        <strong>Partner View:</strong> Showing only your activities. Logged in as <strong><?php echo e(strtolower($user->name)); ?></strong>
    </div>
    <?php endif; ?>

    
    <?php if($totalFilteredCount > 0): ?>
    <div class="stats-strip">
        <div class="stat-chip">
            <div class="stat-val"><?php echo e($activities->total()); ?></div>
            <div class="stat-lbl"><?php echo e($isApprovedPartner ? 'Your' : 'Total'); ?><br>Activities</div>
        </div>
        <div class="stat-chip">
            <div class="stat-val"><?php echo e($activities->currentPage()); ?></div>
            <div class="stat-lbl">Current<br>Page</div>
        </div>
        <div class="stat-chip">
            <div class="stat-val"><?php echo e($activities->lastPage()); ?></div>
    ...
    <div class="d-block d-lg-none">
        <?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="m-card">
                <div class="m-name"><?php echo e($activity->activityName ?? 'Untitled Activity'); ?></div>
                <div class="m-meta">
                    <i class="fas fa-location-dot"></i>
                    <?php echo e($activity->activityLocation ?? 'Location not specified'); ?>

                </div>
                <?php if($activity->emirate): ?>
                <div class="m-meta">
                    <i class="fas fa-flag"></i>
                    <?php echo e($activity->emirate->emiratesName); ?>

                </div>
                <?php endif; ?>
                <div class="m-meta">
                    <i class="fas fa-user"></i>
                    <?php echo e($activity->createdBy ?? 'Unknown'); ?>

                    <?php if(strtolower($activity->createdBy ?? '') === strtolower($user->name)): ?>
                        <i class="fas fa-check-circle" style="color: var(--green); font-size: 10px;"></i>
                    <?php endif; ?>
                </div>
                <?php if($activity->activityPrice): ?>
                <div class="m-meta" style="color: var(--gold);">
                    <i class="fas fa-dollar-sign"></i>
                    <?php echo e(number_format($activity->activityPrice, 2)); ?> AED
                </div>
                <?php endif; ?>
                ...
                <?php if($firstImage): ?>
                    <img src="<?php echo e(asset($firstImage)); ?>" alt="<?php echo e($activity->activityName); ?>" class="m-img"
                         onerror="this.style.display='none'">
                <?php endif; ?>

                <div class="m-actions">
                    <a href="<?php echo e(route('admin.uaeactivities.edit', $activity)); ?>" class="btn-act edit" title="Edit">
                        <i class="fas fa-edit"></i>
                    </a>
                    <button type="button" class="btn-act del delete-btn"
                            data-activity-name="<?php echo e($activity->activityName ?? 'this activity'); ?>"
                            data-activity-id="<?php echo e($activity->id); ?>" title="Delete">
                        <i class="fas fa-trash"></i>
                    </button>
                </div>

                <form method="POST" action="<?php echo e(route('admin.uaeactivities.destroy', $activity)); ?>" class="d-none delete-form">
                    <?php echo csrf_field(); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="empty-box">
                ...
                <h4><?php echo e($isApprovedPartner ? 'No Activities Found' : 'No UAE Activities Found'); ?></h4>
            ...
            <table class="activity-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <span class="row-num"><?php echo e($activities->firstItem() + $index); ?></span>
                            </td>
                            <td>
                                <div class="act-name"><?php echo e($activity->activityName ?? 'Untitled'); ?></div>
                                <?php if($activity->activityPrice): ?>
                                    <div class="act-price"><?php echo e(number_format($activity->activityPrice, 2)); ?> AED</div>
                                <?php endif; ?>
                            </td>
                            <td>
                                <div class="act-location">
                                    <i class="fas fa-location-dot"></i>
                                    <?php echo e($activity->activityLocation ?? '—'); ?>
                            ...
                            <td>
                                ...
                                ?>
                                <?php if($firstImage): ?>
                                    <img src="<?php echo e(asset($firstImage)); ?>" alt="" class="img-thumb"
                            ...
                            <td>
                                <div class="act-actions">
                                    ...
                                    <form method="POST" action="<?php echo e(route('admin.uaeactivities.destroy', $activity)); ?>" class="d-inline delete-form"
                                          data-activity-name="<?php echo e($activity->activityName ?? 'this activity'); ?>">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="button" class="btn-act del delete-btn"
    ...
    <div class="pag-bar">
        <div class="pag-info">
            <?php echo e($activities->firstItem()); ?>–<?php echo e($activities->lastItem()); ?> of <?php echo e($activities->total()); ?>

        </div>

        
        <a href="<?php echo e($activities->currentPage() > 1 ? $activities->url($activities->currentPage() - 1) : '#'); ?>"
           class="pag-btn <?php echo e($activities->currentPage() == 1 ? 'disabled' : ''); ?>">
            <i class="fas fa-chevron-left" style="font-size:10px;"></i>
        </a>

        
        <?php for($i = 1; $i <= $activities->lastPage(); $i++): ?>
            <a href="<?php echo e($activities->url($i)); ?>" class="pag-btn <?php echo e($i == $activities->currentPage() ? 'active' : ''); ?>"><?php echo e($i); ?></a>
        <?php endfor; ?>

        
        <a href="<?php echo e($activities->currentPage() < $activities->lastPage() ? $activities->url($activities->currentPage() + 1) : '#'); ?>"
           class="pag-btn <?php echo e($activities->currentPage() == $activities->lastPage() ? 'disabled' : ''); ?>">
        ...
        <div class="pag-goto">
            <span>Go to</span>
            <input type="number" id="gotoPage" min="1" max="<?php echo e($activities->lastPage()); ?>" placeholder="<?php echo e($activities->currentPage()); ?>">
    ...
    function goToPage() {
        ...
        const max = <?php echo e($activities->lastPage()); ?>;
        if (page >= 1 && page <= max) {
            window.location.href = '<?php echo e($activities->url(1)); ?>'.replace(/page=\d+/, 'page=' + page);
        } else {
    ...
    <div class="d-none d-lg-block">
        <div class="empty-box">
            ...
            <p>
                <?php if($isApprovedPartner): ?>
                    You haven't created any activities yet. Logged in as: <strong><?php echo e(strtolower($user->name)); ?></strong>
                <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/uaeactivities/index.blade.php ENDPATH**/ ?>
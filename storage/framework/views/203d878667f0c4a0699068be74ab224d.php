                            ...
                            <table class="table table-dark table-hover datatable datatable-User">
                                ...
                                <tbody>
                                    ...
                                    <tr data-entry-id="<?php echo e($user->id); ?>">
                                        ...
                                        <td>
                                            <div class="user-info">
                                                <strong class="text-white"><?php echo e($user->name); ?></strong>
                                                <?php if($user->phone): ?>
                                                    <div class="mt-1">
                                                        <small class="text-light-muted">
                                                            <i class="fas fa-phone me-1"></i><?php echo e($user->phone); ?>
                                        ...
                                        <td>
                                            <?php if(!empty($emiratesNames)): ?>
                                                <div class="emirates-list">
                                                    <?php $__currentLoopData = $emiratesNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emirateName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <span class="badge bg-info-custom emirates-badge mb-1 me-1">
                                                            <i class="fas fa-map-pin me-1"></i><?php echo e($emirateName); ?>
                                                ...
                                                <div class="mt-1">
                                                    <small class="text-light-muted">
                                                        <?php echo e(count($emiratesNames)); ?> Emirates Selected
                                                    </small>
                                                </div>
                                            <?php else: ?>
                                        ...
                                        <td class="text-center">
                                            <?php if($isPartner): ?>
                                                ...
                                                <?php if(!empty($adminComments)): ?>
                                                    <div class="mt-1">
                                                        <small class="text-info" data-bs-toggle="tooltip" title="<?php echo e($adminComments); ?>">
                                        ...
                                        <td class="text-center">
                                            ...
                                            ?>
                                            <?php if(in_array('Admin', $userRolesList)): ?>
                                                <span class="badge rounded-pill px-3 py-1 badge-gold">
                                                    <i class="fas fa-shield-alt me-1"></i>Full Access
                                                </span>
                                            <?php elseif(!empty($userRolesList)): ?>
                                                <?php $__currentLoopData = $userRolesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roleName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td class="text-center">
                                            <?php if(count($filePaths)): ?>
                                                <?php $__currentLoopData = $filePaths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $filePath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <a href="<?php echo e(asset($filePath)); ?>" download
                                                       class="btn btn-outline-primary btn-sm mb-1"
                                                       title="Download Document <?php echo e($i + 1); ?>">
                                                        <i class="fas fa-download"></i>
                                                        <?php echo e(__('File')); ?> <?php echo e($i + 1); ?>
...
$(function () {
    ...
    $('#confirmDeleteBtn').on('click', function() {
        if (currentUserId) {
            ...
            deleteForm.attr('action', `<?php echo e(route('admin.users.index')); ?>/${currentUserId}`);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Pragathi\Desktop\GoTrips-Complete\resources\views/admin/users/index.blade.php ENDPATH**/ ?>
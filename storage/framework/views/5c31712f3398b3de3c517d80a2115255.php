<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex align-items-center justify-content-between mb-5">
        <div>
            ...
            <?php else: ?>
                ...
                <p class="text-muted small mb-0">Welcome back, <?php echo e(auth()->user()->name); ?>. Manage your activities below.</p>
            <?php endif; ?>
        </div>
        <div class="d-none d-md-block">
            <span class="badge bg-light-dark text-muted py-2 px-3 border border-secondary border-opacity-10">
                <i class="far fa-calendar-alt me-2"></i><?php echo e(date('D, M d, Y')); ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stats-card stats-card-indigo h-100">
                <div class="card-body p-4">
                    ...
                    <h3 class="stats-value text-white mb-1"><?php echo e($stats['total_users']); ?></h3>
                    <p class="stats-label text-muted mb-0">Total Users</p>
                </div>
            </div>
        </div>

        <!-- Announcements Card (Admin Only) -->
        <div class="col-xl-3 col-md-6">
            <div class="stats-card stats-card-gold h-100">
                <div class="card-body p-4">
                    ...
                    <h3 class="stats-value text-white mb-1"><?php echo e($stats['total_announcements']); ?></h3>
                    <p class="stats-label text-muted mb-0">Announcements</p>
                </div>
            </div>
        </div>

        <!-- Travel Packages Card (Admin Only) -->
        <div class="col-xl-3 col-md-6">
            <div class="stats-card stats-card-blue h-100">
                <div class="card-body p-4">
                    ...
                    <h3 class="stats-value text-white mb-1"><?php echo e($stats['total_travel_packages']); ?></h3>
                    <p class="stats-label text-muted mb-0">Travel Packages</p>
                </div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="<?php echo e(auth()->user()->isAdmin() ? 'col-xl-3 col-md-6' : 'col-xl-4 col-md-6'); ?>">
            <div class="stats-card stats-card-green h-100">
                <div class="card-body p-4">
                    ...
                    <h3 class="stats-value text-white mb-1"><?php echo e($stats['total_activities']); ?></h3>
                    <p class="stats-label text-muted mb-0">UAE Activities</p>
                </div>
            </div>
        </div>
        ...
        <!-- Umrah Packages Card -->
        <div class="<?php echo e(auth()->user()->isAdmin() ? 'col-xl-3 col-md-6' : 'col-xl-4 col-md-6'); ?>">
            <div class="stats-card stats-card-purple h-100">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <h3 class="stats-value text-white mb-1"><?php echo e($stats['total_umrah_packages']); ?></h3>
                    <p class="stats-label text-muted mb-0">Umrah Packages</p>
                </div>
            </div>
        </div>

        <?php if(auth()->user()->isActivitiesManager() && !auth()->user()->isAdmin()): ?>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="stats-card action-card action-card-primary h-100">
                <div class="card-body p-4 d-flex flex-column justify-content-center align-items-center text-center">
                    ...
                    <a href="<?php echo e(route('admin.uaeactivities.create')); ?>" class="btn btn-sm btn-action-gold">
                        Create Activity
                    </a>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="stats-card action-card action-card-secondary h-100">
                <div class="card-body p-4 d-flex flex-column justify-content-center align-items-center text-center">
                    ...
                    <a href="<?php echo e(route('admin.uaeactivities.index')); ?>" class="btn btn-sm btn-action-outline">
                        View All
                    </a>
                </div>
            </div>
...
<style>
    ...
    .stats-icon-purple { background: rgba(168, 85, 247, 0.1); color: #a855f7; }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>
    ...
    <div class="visa-wrapper">
        ...
        <div class="visa-main">
            ...
            <div class="card">
                ...
                <form id="visaForm" method="POST" action="<?php echo e(route('uaev.submit')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-grid-3">
                        ...
                        <div class="form-field">
                            ...
                            <select class="field-input" id="visaCount" name="visa_count" required>
                                <?php for($i = 1; $i <= 10; $i++): ?>
                                    <option value="<?php echo e($i); ?>" <?php echo e($i === 1 ? 'selected' : ''); ?>><?php echo e($i); ?> <?php echo e($i === 1 ? 'Adult' : 'Adults'); ?></option>
                                <?php endfor; ?>
                            </select>
                        </div>
                        <div class="form-field">
                            ...
                            <select class="field-input" id="visaChildren" name="children_count">
                                <?php for($i = 0; $i <= 10; $i++): ?>
                                    <option value="<?php echo e($i); ?>" <?php echo e($i === 0 ? 'selected' : ''); ?>><?php echo e($i); ?> <?php echo e($i === 1 ? 'Child' : 'Children'); ?></option>
                                <?php endfor; ?>
                            </select>
                        </div>
                        <div class="form-field">
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/uaevisa.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="password" class="form-label">Password <span class="text-required">*</span></label>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="access-type-card" id="fullAccessCard" onclick="selectAccessType('full')">
                                        <input type="radio" name="access_type" value="full" id="accessFull"
                                               <?php echo e(old('access_type', 'full') === 'full' ? 'checked' : ''); ?> class="d-none">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="access-type-card" id="specificAccessCard" onclick="selectAccessType('specific')">
                                        <input type="radio" name="access_type" value="specific" id="accessSpecific"
                                               <?php echo e(old('access_type') === 'specific' ? 'checked' : ''); ?> class="d-none">
                                        <div class="access-card-inner">
                                            <div class="access-card-icon">
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <label class="module-checkbox-card">
                                            <input type="checkbox" name="modules[]" value="uaeactivities"
                                                   <?php echo e(is_array(old('modules')) && in_array('uaeactivities', old('modules')) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <label class="module-checkbox-card">
                                            <input type="checkbox" name="modules[]" value="announcements"
                                                   <?php echo e(is_array(old('modules')) && in_array('announcements', old('modules')) ? 'checked' : ''); ?>>
                                            <div class="module-card-inner">
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <label class="module-checkbox-card">
                                            <input type="checkbox" name="modules[]" value="homepageads"
                                                   <?php echo e(is_array(old('modules')) && in_array('homepageads', old('modules')) ? 'checked' : ''); ?>>
                                            <div class="module-card-inner">
...
<script>
    function selectAccessType(type) {
        ...
        if (type === 'full') {
            ...
            // Uncheck all module checkboxes when switching to full
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/users/create.blade.php ENDPATH**/ ?>
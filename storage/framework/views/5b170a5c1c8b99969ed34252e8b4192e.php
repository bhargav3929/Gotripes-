...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .esim-hero {
        ...
        background-image: url('<?php echo e(asset('assets/esim/hero-esim-network.jpg')); ?>');
        background-image: -webkit-image-set(
            url('<?php echo e(asset('assets/esim/hero-esim-network.webp')); ?>') type('image/webp'),
            url('<?php echo e(asset('assets/esim/hero-esim-network.jpg')); ?>') type('image/jpeg')
        );
...
<section class="esim-hero">
    ...
    <link rel="preload" as="image" href="<?php echo e(asset('assets/esim/hero-esim-network.webp')); ?>" type="image/webp" fetchpriority="high">
</section>
...
<section class="esim-partner-cta-banner">
    <div class="epcb-inner">
        ...
        <a href="<?php echo e(route('referral.login')); ?>" class="epcb-btn">
...
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/esim.blade.php ENDPATH**/ ?>
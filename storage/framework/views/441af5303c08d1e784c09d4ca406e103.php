<?php $__env->startSection('title', 'Create UAE Activity'); ?>
                ...
                <div class="card-header">
                    <h3 class="card-title mb-0">
                        ...
                        <?php if($isApprovedPartner): ?>
                            <small class="text-dark ms-2">(Partner: <?php echo e($user->name); ?>)</small>
                        <?php endif; ?>
                    </h3>
                    <div class="card-tools">
                        <a href="<?php echo e(route('admin.uaeactivities.index')); ?>" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-arrow-left me-1"></i> Back to List
                        </a>
                    </div>
                </div>
                <form method="POST" action="<?php echo e(route('admin.uaeactivities.store')); ?>" enctype="multipart/form-data" id="activityForm">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" 
                                           id="activityName" 
                                           name="activityName" 
                                           value="<?php echo e(old('activityName')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('activityLocation')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $emirates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emirate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <option value="<?php echo e($emirate->emiratesID); ?>" 
                                                    <?php echo e(old('emiratesID') == $emirate->emiratesID ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('activityCategory')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                           id="activityPrice" 
                                           name="activityPrice" 
                                           value="<?php echo e(old('activityPrice')); ?>" 
                                           placeholder="0.00"
                                           step="0.01" 
                                           min="0" 
                                           required>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('activityChildPrice')); ?>" 
                                           placeholder="0.00"
                                           step="0.01" 
                                           min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('activityTransactionCharges')); ?>" 
                                           placeholder="0.00"
                                           step="0.01" 
                                           min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                           id="dubaiPrice" 
                                           name="dubaiPrice" 
                                           value="<?php echo e(old('dubaiPrice')); ?>" 
                                           placeholder="0.00"
                                           step="0.01" 
                                           min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                           id="abuDhabiPrice" 
                                           name="abuDhabiPrice" 
                                           value="<?php echo e(old('abuDhabiPrice')); ?>" 
                                           placeholder="0.00"
                                           step="0.01" 
                                           min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('fromAbuDhabiToDubai')); ?>" 
                                           placeholder="0.00"
                                           step="0.01" 
                                           min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                           id="supplierName" 
                                           name="supplierName" 
                                           value="<?php echo e(old('supplierName')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                           id="supplierEmail" 
                                           name="supplierEmail" 
                                           value="<?php echo e(old('supplierEmail')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
    ...
    ><?php echo e(old('detailsOverview')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-footer text-center">
                        <button type="submit" class="btn btn-gold btn-lg me-3" <?php if($emirates->count() == 0): ?> disabled <?php endif; ?>>
                        ...
                        <a href="<?php echo e(route('admin.uaeactivities.index')); ?>" class="btn btn-outline-primary btn-lg">
                            Cancel
                        </a>
                    </div>
                </form>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/uaeactivities/create.blade.php ENDPATH**/ ?>
...
<form action="<?php echo e(route('manager.activities.store')); ?>" method="POST" enctype="multipart/form-data" id="activityForm">
    <?php echo csrf_field(); ?>
            ...
            <div class="wp-card">
                ...
                <div class="wp-card-body">
                    <div class="wp-form-group">
                        ...
                        <input type="text" class="wp-input" name="activityName" value="<?php echo e(old('activityName')); ?>" required placeholder="e.g. Desert Safari Adventure">
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="wp-form-group">
                                ...
                                <select class="wp-select" name="emiratesID" required>
                                    ...
                                    <?php $__currentLoopData = $emirates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emirate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($emirate->emiratesID); ?>" <?php echo e(old('emiratesID') == $emirate->emiratesID ? 'selected' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="wp-form-group">
                                ...
                                <input type="text" class="wp-input" name="activityLocation" value="<?php echo e(old('activityLocation')); ?>" required placeholder="e.g. Dubai Marina">
                            </div>
                        </div>
                    <div class="wp-form-group">
                        <label class="wp-form-label">Activity Category / Type</label>
                        <input type="text" class="wp-input" name="activityCategory" value="<?php echo e(old('activityCategory')); ?>" placeholder="e.g. Adventure, Water Sports, Desert Safari">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="wp-form-group">
                                ...
                                <input type="number" class="wp-input" name="activityPrice" step="0.01" min="0" value="<?php echo e(old('activityPrice')); ?>" required placeholder="0.00">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="wp-form-group">
                                <label class="wp-form-label">Child Price ($)</label>
                                <input type="number" class="wp-input" name="activityChildPrice" step="0.01" min="0" value="<?php echo e(old('activityChildPrice')); ?>" placeholder="0.00">
                        ...
                        <div class="col-md-4">
                            <div class="wp-form-group">
                                ...
                                <input type="number" class="wp-input" name="activityTransactionCharges" step="0.01" min="0" value="<?php echo e(old('activityTransactionCharges')); ?>" placeholder="0.00">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="wp-form-group">
                                ...
                                <input type="text" class="wp-input" name="supplierName" value="<?php echo e(old('supplierName')); ?>" placeholder="e.g. Desert Safari Tours LLC">
                        ...
                        <div class="col-md-6">
                            <div class="wp-form-group">
                                ...
                                <input type="email" class="wp-input" name="supplierEmail" value="<?php echo e(old('supplierEmail')); ?>" placeholder="supplier@example.com">
            ...
            <div class="wp-card">
                ...
                <div class="wp-card-body">
                    <div class="wp-form-group" style="margin-bottom: 0;">
                        <textarea class="wp-textarea" name="detailsOverview" rows="6" required placeholder="Write a detailed description of this activity..."><?php echo e(old('detailsOverview')); ?></textarea>
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/manager/activities/create.blade.php ENDPATH**/ ?>
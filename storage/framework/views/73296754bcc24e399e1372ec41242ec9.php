    ...
    <div class="row g-3">
        <div class="col-lg-8">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('referral.profile.update')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control form-control-sm" value="<?php echo e($agent->email); ?>" disabled>
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('phone', $agent->phone)); ?>" placeholder="+971 50 123 4567">
                            </div>
                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <span class="badge bg-<?php echo e($agent->status === 'active' ? 'success' : 'secondary'); ?>"><?php echo e(ucfirst($agent->status)); ?></span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body text-center">
                    <div class="profile-avatar mb-2"><?php echo e(strtoupper(substr($agent->name, 0, 2))); ?></div>
                    <div class="fw-500"><?php echo e($agent->name); ?></div>
                    <small class="text-muted"><?php echo e($agent->email); ?></small>

                    <hr class="border-dark my-2">

                    <div class="info-row"><span>Member Since</span><span><?php echo e($agent->created_at->format('M Y')); ?></span></div>
                    <div class="info-row"><span>Total Sales</span><span><?php echo e(number_format($agent->total_sales)); ?></span></div>
                    <div class="info-row"><span>Total Earnings</span><span class="text-success">AED <?php echo e(number_format($agent->total_earnings, 2)); ?></span></div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-2">
                        ...
                        <div class="code-box"><?php echo e($agent->referral_code); ?></div>
                    </div>
                    <div class="mb-2">
                        <small class="text-muted">URL</small>
                        <div class="url-box"><?php echo e($agent->referral_url); ?></div>
                    </div>
                    <button class="btn btn-gold btn-sm w-100 copy-btn" data-copy="<?php echo e($agent->referral_url); ?>">
...
<?php echo $__env->make('layouts.referral', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/referral/profile.blade.php ENDPATH**/ ?>
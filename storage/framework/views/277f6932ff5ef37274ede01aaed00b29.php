...
<?php $__env->startSection('page-title', 'Manage Announcements'); ?>
                    ...
                    <div class="d-block d-lg-none">
                        ...
                        <div class="card bg-light-dark border-gold mb-3 mobile-card animate-scale">
                            <div class="card-body p-3">
                                ...
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <div class="flex-grow-1">
                                        <h6 class="card-title text-gold mb-1 fw-semibold">
                                            #<?php echo e($announcements->firstItem() + $index); ?>

                                        </h6>
                                        <p class="card-text text-white mb-2 fs-7">
                                            <?php echo e(Str::limit($announcement->description, 45)); ?>

                                        </p>
                                    </div>
                                    <?php if($announcement->flagPath): ?>
                                    <div class="ms-2">
                                        <img src="<?php echo e(asset($announcement->flagPath)); ?>" 
                                             alt="Flag" 
                                ...
                                <!-- Mobile Badges -->
                                <div class="mb-2">
                                    <?php if($announcement->announcementImportance == 1): ?>
                                    <span class="badge bg-success-custom me-1">
                                        <i class="fas fa-star me-1"></i>New
                                    </span>
                                    <?php endif; ?>
                                    <span class="badge bg-info-custom">
                                        <?php echo e($announcement->createdBy ?? 'System'); ?>
                                ...
                                <div class="mb-3">
                                    <small class="text-light-muted">
                                        ...
                                        <?php echo e($announcement->createdDate ? \Carbon\Carbon::parse($announcement->createdDate)->format('M d, Y H:i') : 'N/A'); ?>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="button"
                                            ...
                                            data-announcement-id="<?php echo e($announcement->id); ?>"
                                            data-announcement-title="<?php echo e(Str::limit($announcement->description, 30)); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    <span class="text-white"><?php echo e(Str::limit($announcement->description, 60)); ?></span>
                                                    <div class="mt-1">
                                                        <?php if($announcement->announcementImportance == 1): ?>
                                                        <span class="badge bg-success-custom me-1">
                                                            <i class="fas fa-star me-1"></i>New
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex align-items-center justify-content-center gap-1">
                                                ...
                                                <button type="button"
                                                        ...
                                                        data-announcement-id="<?php echo e($announcement->id); ?>"
                                                        data-announcement-title="<?php echo e(Str::limit($announcement->description, 40)); ?>"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        if (currentAnnouncementId) {
            ...
            deleteForm.action = `<?php echo e(route('admin.announcements.index')); ?>/${currentAnnouncementId}`;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/announcements/index.blade.php ENDPATH**/ ?>
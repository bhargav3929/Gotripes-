...
<div class="container-fluid py-3">
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="<?php echo e(route('admin.referrals.withdrawals.index')); ?>" class="btn btn-sm btn-outline-info">
                        Manage Withdrawals
                        <?php if(($stats['pending_withdrawals'] ?? 0) > 0): ?>
                        <span class="badge bg-warning ms-1" style="font-size: 0.55rem; padding: 2px 5px;"><?php echo e($stats['pending_withdrawals']); ?></span>
                        <?php endif; ?>
                    </a>
                    <a href="<?php echo e(route('admin.referrals.settings')); ?>" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-lg-3">
            <div class="stat-card clickable" onclick="window.location='<?php echo e(route('admin.referrals.withdrawals.index', ['status' => 'pending'])); ?>'">
                <div class="stat-icon red"><i class="fas fa-money-bill-wave"></i></div>
                <div class="stat-number text-danger"><?php echo e($stats['pending_withdrawals'] ?? 0); ?></div>
                <div class="stat-label">Pending Withdrawals</div>
                <small class="text-danger">AED <?php echo e(number_format($stats['pending_withdrawal_amount'] ?? 0, 2)); ?></small>
            </div>
        </div>
        <div class="col-6 col-lg-3">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/referrals/dashboard.blade.php ENDPATH**/ ?>
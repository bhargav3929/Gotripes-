...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">
                Dear <strong><?php echo e($data['name'] ?? 'Customer'); ?></strong>,
                <?php if($isSuccess): ?>
            ...
            <div class="activity-card">
                <h2><?php echo e($data['activity_name'] ?? ($data['activityName'] ?? 'Activity Booking')); ?></h2>
                <?php if(!empty($data['activityLocation'])): ?>
                    <p><span class="icon">📍</span><?php echo e($data['activityLocation']); ?></p>
                <?php endif; ?>
                <?php if(!empty($data['booking_date'])): ?>
                    <p><span class="icon">📅</span><?php echo e($data['booking_date']); ?></p>
                <?php elseif(!empty($data['date'])): ?>
                    <p><span class="icon">📅</span><?php echo e(\Carbon\Carbon::parse($data['date'])->format('l, F j, Y')); ?></p>
                <?php endif; ?>
                <p style="margin-top: 12px;"><span class="icon">🔖</span>Order ID: <strong><?php echo e($data['order_id'] ?? 'N/A'); ?></strong></p>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="detail-row">
                    ...
                    <span class="value"><?php echo e($data['name'] ?? 'N/A'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="label"><span class="icon">📧</span>Email:</span>
                    <span class="value"><?php echo e($data['email'] ?? 'N/A'); ?></span>
                </div>
                <?php if(!empty($data['phone'])): ?>
                <div class="detail-row">
                    <span class="label"><span class="icon">📞</span>Phone:</span>
                    <span class="value"><?php echo e($data['phone']); ?></span>
                </div>
                <?php endif; ?>
                <?php if(!empty($data['adults'])): ?>
                <div class="detail-row">
                    <span class="label"><span class="icon">👥</span>Adults:</span>
                    <span class="value"><?php echo e($data['adults']); ?> person(s)</span>
                </div>
                <?php endif; ?>
                <?php if(!empty($data['childrens']) && $data['childrens'] > 0): ?>
                <div class="detail-row">
                    <span class="label"><span class="icon">👶</span>Children:</span>
                    <span class="value"><?php echo e($data['childrens']); ?> person(s)</span>
                </div>
                <?php endif; ?>
                <?php if(!empty($data['transfer']) && $data['transfer'] !== 'without_transfer'): ?>
                <div class="detail-row">
                    ...
                    <span class="value">
                        ...
                        ?>
                        <?php echo e($transferMap[$data['transfer']] ?? ucwords(str_replace('_', ' ', $data['transfer']))); ?>
            ...
            <div class="info-box">
                ...
                <div style="text-align: center; margin: 15px 0;">
                    <div class="amount-box">
                        <?php echo e($data['amount'] ?? '0'); ?> <?php echo e($data['currency'] ?? 'AED'); ?>
                ...
                <div class="detail-row">
                    ...
                    <span class="value"><?php echo e($data['order_id'] ?? 'N/A'); ?></span>
                </div>
                <?php if(!empty($data['tracking_id'])): ?>
                <div class="detail-row">
                    <span class="label"><span class="icon">🔍</span>Tracking ID:</span>
                    <span class="value"><?php echo e($data['tracking_id']); ?></span>
                </div>
                <?php endif; ?>
                <?php if(!empty($data['bank_ref_no'])): ?>
                <div class="detail-row">
                    <span class="label"><span class="icon">🏦</span>Reference:</span>
                    <span class="value"><?php echo e($data['bank_ref_no']); ?></span>
                </div>
                <?php endif; ?>
                <div class="detail-row">
                    <span class="label"><span class="icon">📅</span>Date:</span>
                    <span class="value"><?php echo e($data['sent_at'] ?? now()->format('M j, Y g:i A')); ?></span>
                </div>
            </div>
            ...
            <!-- Next Steps -->
            <div class="next-steps <?php echo e($isFailed ? 'failed' : ($isCancelled ? 'cancelled' : '')); ?>">
                <?php if($isSuccess): ?>
                    ...
                    <ul>
                        ...
                        <li>Keep your Order ID <strong><?php echo e($data['order_id'] ?? ''); ?></strong> for reference</li>
                    </ul>
                <?php elseif($isFailed): ?>
        ...
        <div class="footer">
            <p><strong><?php echo e(config('app.name', 'Go Trips')); ?></strong></p>
            ...
            <div class="support-box">
                ...
                <p style="font-size: 13px; color: #e0e0e0; margin: 4px 0;">
                    📧 <?php echo e(config('mail.from.address', 'info@aynalamirtourism.com')); ?>
                ...
                <p style="font-size: 12px; color: #aaa; margin: 8px 0 0;">
                    Reference your Order ID: <?php echo e($data['order_id'] ?? 'N/A'); ?>
...
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/emails/customer-payment-confirmation.blade.php ENDPATH**/ ?>
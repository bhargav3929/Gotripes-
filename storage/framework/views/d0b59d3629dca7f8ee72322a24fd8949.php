    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <?php if($user->isAdmin()): ?>
                    <li class="nav-item <?php echo e((request()->is('admin/users') || request()->is('admin/users*')) ? 'active' : ''); ?>">
                ...
                <?php if($user->hasPermission('announcement_access')): ?>
                    <li class="nav-item">
                ...
                <?php if($user->hasPermission('homepage_ads_access')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.homepageads.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.homepageads.*') ? 'active' : ''); ?>">
                ...
                <?php if($user->hasPermission('activity_access')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.uaeactivities.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.uaeactivities.*') ? 'active' : ''); ?>">
                ...
                <?php if($user->isAdmin()): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.umrah-packages.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.umrah-packages.*') ? 'active' : ''); ?>">
                ...
                <?php if($user->isAdmin()): ?>
                    <li class="nav-item <?php echo e(request()->routeIs('admin.referrals.*') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('admin.referrals.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.referrals.*') ? 'active' : ''); ?>">
                ...
                <?php if($isPartnerRestricted && $userType === 'approved_partner' && !$user->hasPermission('activity_access')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.uaeactivities.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.uaeactivities.*') ? 'active' : ''); ?>">
                            <i class="fas fa-map-marked-alt"></i>
                            <span>UAE Activities</span>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown" 
                           role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="me-2 d-none d-lg-inline fw-medium"><?php echo e(auth()->user()->name); ?></span>
                            <img class="img-profile rounded-circle" width="32" height="32"
                                 src="<?php echo e(asset('backend/img/undraw_profile.svg')); ?>" alt="Profile">
                        </a>
            ...
            <div id="content">
                <div class="container-fluid pt-0">
                    ...
                    <?php if(session()->has('message')): ?>
                        <div class="alert alert-<?php echo e(session()->get('alert-type', 'info')); ?> alert-dismissible fade show animate-fade-in mt-3" 
                             role="alert" id="alert-message">
                            <i class="fas fa-<?php echo e(session()->get('alert-type') == 'success' ? 'check-circle' : 'info-circle'); ?> me-2"></i>
                ...
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span class="text-primary fw-bold">
                            ...
                            <span class="d-none d-sm-inline">Copyright &copy; <?php echo e(date('Y')); ?> Go Trips. All rights reserved.</span>
                            <span class="d-sm-none">&copy; <?php echo e(date('Y')); ?> Go Trips</span>
                        </span>
                    </div>
                </div>
            </footer>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex gap-2">
                    <form action="<?php echo e(route('logout')); ?>" method="POST" class="d-flex gap-2 flex-grow-1">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Pragathi\Desktop\GoTrips-Complete\resources\views/layouts/admin.blade.php ENDPATH**/ ?>
...
<section class="content-section"
  style="background: url('<?php echo e(asset('assets/index_files/I1.jpeg')); ?>') center center/cover fixed;">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-11 col-xxl-10">
          <div class="glass-card">
            ...
            <form id="jobApplicationForm" method="POST" action="<?php echo e(route('job.application.submit')); ?>"
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/lookingforajob.blade.php ENDPATH**/ ?>
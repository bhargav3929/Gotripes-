                            ...
                            <div class="col-12 col-lg-8">
                                <div class="mb-3 mb-md-4">
                                    ...
                                    <select class="form-control form-control-mobile" id="tagType" name="tagType">
                                        ...
                                        <option value="breaking" <?php echo e(old('tagType') == 'breaking' ? 'selected' : ''); ?>>BREAKING (Red)</option>
                                        <option value="trending" <?php echo e(old('tagType') == 'trending' ? 'selected' : ''); ?>>TRENDING (Gold)</option>
                                        <option value="exclusive" <?php echo e(old('tagType') == 'exclusive' ? 'selected' : ''); ?>>EXCLUSIVE (Green)</option>
                                        <option value="alert" <?php echo e(old('tagType') == 'alert' ? 'selected' : ''); ?>>NEW / ALERT (Blue)</option>
                                        <option value="hot" <?php echo e(old('tagType') == 'hot' ? 'selected' : ''); ?>>HOT (Yellow)</option>
                                    </select>
                                    <div class="form-text text-light-muted">
                                            ...
                                            <div class="card-body p-2 p-sm-3">
                                                ...
                                                <div class="form-check form-switch mb-2 mb-sm-3">
                                                    <input class="form-check-input mobile-switch" 
                                                           ...
                                                           value="1"
                                                           <?php echo e(old('announcementImportance') ? 'checked' : ''); ?>>
                                                    <label class="form-check-label fw-medium text-white ms-2 fs-7 fs-sm-6" for="announcementImportance">
                                                        ...
                                                        <span class="d-none d-sm-inline">Mark as <strong>New</strong></span>
                                                        <span class="d-sm-none"><strong>New</strong></span>
                                                    </label>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div id="svgPreview" class="text-center d-none">
                                                    <div class="border border-gold rounded p-2 bg-dark">
                                                        <div id="previewSvg" class="mobile-preview-svg"></div>
                                                        <div class="mt-1 mt-sm-2">
                                                            <small class="text-gold">SVG Preview</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="alert alert-warning-custom border-0 p-2 mb-0">
                                                    <small class="text-light-warning fs-8 fs-sm-7">
                                                        ...
                                                        <span class="d-none d-sm-inline"><strong>Max Size:</strong> 2MB | <strong>Vector graphics only</strong></span>
                                                        <span class="d-sm-none"><strong>Max:</strong> 2MB</span>
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-stretch align-items-sm-center gap-2">
                            ...
                            <div class="d-flex gap-2 order-1 order-sm-2">
                                ...
                                <button type="submit" class="btn btn-primary flex-fill flex-sm-grow-0 animate-scale" id="submitBtn">
                                    ...
                                    <span class="d-none d-sm-inline">Create Announcement</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        const isMobile = window.innerWidth < 576;
        submitBtn.innerHTML = `<span class="spinner-border spinner-border-sm me-1" role="status"></span>${isMobile ? 'Creating...' : 'Creating...'}`;
        submitBtn.disabled = true;
        
        setTimeout(() => {
            submitBtn.innerHTML = `<i class="fas fa-save me-1 me-sm-2"></i> ${isMobile ? 'Create' : 'Create Announcement'}`;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/admin/announcements/create.blade.php ENDPATH**/ ?>
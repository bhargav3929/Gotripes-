...
<div class="wp-page-header">
    ...
    <a href="<?php echo e(route('manager.activities.index')); ?>" class="wp-btn wp-btn-secondary">
        <i class="fas fa-arrow-left"></i> Back to Activities
    </a>
</div>

<form action="<?php echo e(route('manager.activities.update', $activity->activityID)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
            ...
            <div class="wp-card">
                ...
                <div class="wp-card-body">
                    <div class="wp-form-group">
                        ...
                        <input type="text" class="wp-input" name="activityName" value="<?php echo e(old('activityName', $activity->activityName)); ?>" required>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="wp-form-group">
                                ...
                                <input type="text" class="wp-input" name="activityLocation" value="<?php echo e(old('activityLocation', $activity->activityLocation)); ?>" required>
                            </div>
                        </div>
                    <div class="wp-form-group">
                        <label class="wp-form-label">Activity Category / Type</label>
                        <input type="text" class="wp-input" name="activityCategory" value="<?php echo e(old('activityCategory', $activity->activityCategory)); ?>" placeholder="e.g. Adventure, Water Sports, Desert Safari">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="wp-form-group">
                                ...
                                <input type="number" class="wp-input" name="activityPrice" step="0.01" min="0" value="<?php echo e(old('activityPrice', $activity->activityPrice)); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="wp-form-group">
                                <label class="wp-form-label">Child Price ($)</label>
                                <input type="number" class="wp-input" name="activityChildPrice" step="0.01" min="0" value="<?php echo e(old('activityChildPrice', $activity->activityChildPrice)); ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="wp-form-group">
                                <label class="wp-form-label">Transaction Charges ($)</label>
                                <input type="number" class="wp-input" name="activityTransactionCharges" step="0.01" min="0" value="<?php echo e(old('activityTransactionCharges', $activity->activityTransactionCharges)); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="wp-form-group">
                                ...
                                <input type="text" class="wp-input" name="supplierName" value="<?php echo e(old('supplierName', $activity->supplierName)); ?>" placeholder="e.g. Desert Safari Tours LLC">
                        ...
                        <div class="col-md-6">
                            <div class="wp-form-group">
                                ...
                                <input type="email" class="wp-input" name="supplierEmail" value="<?php echo e(old('supplierEmail', $activity->supplierEmail)); ?>" placeholder="supplier@example.com">
                ...
                <div class="wp-card-body">
                    <?php if(count($existingImages) > 0): ?>
                        <p style="font-size: 12px; color: var(--wp-text-muted); margin-bottom: 10px;">
                            <i class="fas fa-info-circle"></i> Current images (<?php echo e(count($existingImages)); ?>):
                        </p>
                        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(120px, 1fr)); gap: 10px; margin-bottom: 16px;">
                            <?php $__currentLoopData = $existingImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $imagePath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div style="position: relative; border-radius: 6px; overflow: hidden; border: 1px solid var(--wp-border-light); background: #222;">
                                    <img src="<?php echo e(asset($imagePath)); ?>" alt="Image <?php echo e($index + 1); ?>"
            ...
            <div class="wp-card">
                ...
                <div class="wp-card-body">
                    <div class="wp-form-group" style="margin-bottom: 0;">
                        <textarea class="wp-textarea" name="detailsOverview" rows="6" required><?php echo e(old('detailsOverview', $details->detailsOverview ?? '')); ?></textarea>
                        ...
                        <?php if(count($detailsIminfo) > 0): ?>
                            <?php $__currentLoopData = $detailsIminfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="iminfo-row" style="display: flex; gap: 8px; margin-bottom: 8px;">
                                    <input type="text" class="wp-input" name="detailsIminfo[]" value="<?php echo e($info); ?>" required style="flex: 1;">
            ...
            <div class="wp-card">
                ...
                <div class="wp-card-body">
                    <div id="highlightsContainer">
                        <?php if(count($detailsHighlights) > 0): ?>
                            <?php $__currentLoopData = $detailsHighlights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $highlight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="highlight-row" style="display: flex; gap: 8px; margin-bottom: 8px;">
                                    <input type="text" class="wp-input" name="detailsHighlights[]" value="<?php echo e($highlight); ?>" required style="flex: 1;">
                                    <button type="button" class="wp-btn wp-btn-danger wp-btn-sm remove-row" style="flex-shrink: 0;" onclick="removeRow(this)">
                                        <i class="fas fa-times"></i>
                                    </button>
                                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="wp-card" style="position: sticky; top: 68px;">
                ...
                <div class="wp-card-body" style="font-size: 13px; color: var(--wp-text-secondary);">
                    <p style="margin-bottom: 8px;"><i class="fas fa-user" style="width: 16px; color: var(--wp-text-muted);"></i> Created by: <strong><?php echo e($activity->createdBy ?? 'Unknown'); ?></strong></p>
                    <?php if($activity->createdDate): ?>
                        <p style="margin-bottom: 8px;"><i class="fas fa-calendar" style="width: 16px; color: var(--wp-text-muted);"></i> Created: <?php echo e(\Carbon\Carbon::parse($activity->createdDate)->format('M d, Y')); ?></p>
                    <?php endif; ?>
                    <?php if($activity->modifiedDate): ?>
                        <p style="margin-bottom: 0;"><i class="fas fa-clock" style="width: 16px; color: var(--wp-text-muted);"></i> Modified: <?php echo e(\Carbon\Carbon::parse($activity->modifiedDate)->format('M d, Y')); ?></p>
                    <?php endif; ?>
                </div>
                <div class="wp-card-footer" style="display: flex; flex-direction: column; gap: 8px;">
                    ...
                    <form action="<?php echo e(route('manager.activities.destroy', $activity->activityID)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this activity?');" style="width: 100%;">
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/manager/activities/edit.blade.php ENDPATH**/ ?>
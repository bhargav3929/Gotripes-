...
<head>
    ...
    <title>Payment <?php echo e(($response['order_status'] ?? '') === 'Success' ? 'Successful' : 'Status'); ?> - GoTrip</title>
...
<body>
    <div class="status-wrapper">
        ...
        <div class="status-icon-wrapper">
            <?php if(($response['order_status'] ?? '') === 'Success'): ?>
                <div class="status-icon success">
                    <i class="bi bi-check-lg"></i>
                </div>
            <?php elseif(($response['order_status'] ?? '') === 'Cancelled'): ?>
        ...
        <?php if(($response['order_status'] ?? '') !== 'Success'): ?>
            <?php if(!empty($response['failure_message']) && $response['failure_message'] !== 'Not provided'): ?>
                <div class="error-card">
                    <p><strong>Reason:</strong> <?php echo e($response['failure_message']); ?></p>
                </div>
            <?php endif; ?>
        <?php endif; ?>
        ...
        <div class="status-card">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value"><?php echo e($response['order_id'] ?? 'N/A'); ?></div>
            </div>
            ...
            <div class="detail-row">
                ...
                <div class="detail-value"><?php echo e($response['payment_mode'] ?? 'Online Checkout'); ?></div>
            </div>

            <?php if(!empty($response['tracking_id']) || !empty($response['bank_ref_no'])): ?>
            <div class="detail-row">
                <div class="detail-label">
                    <i class="bi bi-upc-scan"></i>
                    <span>Reference</span>
                </div>
                <div class="detail-value"><?php echo e($response['bank_ref_no'] ?? $response['tracking_id'] ?? 'N/A'); ?></div>
            </div>
            <?php endif; ?>
            ...
            <div class="amount-row">
                ...
                <span class="amount-value"><?php echo e(number_format((float)($response['amount'] ?? 0), 2)); ?><small><?php echo e($response['currency'] ?? 'AED'); ?></small></span>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="btn-group">
            <a href="<?php echo e(url('/')); ?>" class="btn-primary-gold">
                <i class="bi bi-house-fill"></i>
                Home
            </a>
            <?php if(($response['order_status'] ?? '') !== 'Success'): ?>
            <a href="<?php echo e(url('/')); ?>" class="btn-outline">
...
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/payment/status.blade.php ENDPATH**/ ?>
...
<style>
    ...
    .contact-section-wrapper {
        position: relative;
        padding: 80px 0;
        background: url('<?php echo e(asset('assets/index_files/kalifa.jpg')); ?>') center center / cover no-repeat fixed;
    }
    ...
    <div class="container position-relative" style="z-index: 2;">
        ...
        <div class="row g-4 d-flex align-items-stretch">
            ...
            <div class="col-lg-6">
                <div class="glass-card">
                    ...
                    <!-- Form -->
                    <form id="contactForm" action="<?php echo e(route('contact.submit')); ?>" method="POST" class="premium-form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
        ...
        <div class="row mt-5 pt-4 g-4 justify-content-center">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="qr-card">
                    <div class="qr-img">
                        <img src="<?php echo e(asset('assets/index_files/LocationQR-2.jpg')); ?>" alt="Location QR">
                    </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="qr-card">
                    <div class="qr-img" style="background: transparent;">
                        <img src="<?php echo e(asset('assets/index_files/logo.png')); ?>" alt="Logo">
                    </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="qr-card">
                    <div class="qr-img">
                        <img src="<?php echo e(asset('assets/index_files/WhatsappQR.jpg')); ?>" alt="WA QR">
                    </div>
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/contact-us.blade.php ENDPATH**/ ?>
                ...
                <div class="activity-item">
                    <div class="blog_inner_page">
                        <div class="activity-box-container position-relative">
                            ...
                            <a href="/dubai-global-village?id=<?php echo e($activity->activityID); ?>" style="text-decoration: none;">
                            ...
                            <div class="blog_box">
                                <a href="/dubai-global-village?id=<?php echo e($activity->activityID); ?>" style="text-decoration: none;">
                                    <h3><?php echo e($activity->activityName); ?></h3>
                                ...
                                <div class="author">
                                    <div class="price-wrapper">
                                        ...
                                        <span class="price" data-amount="<?php echo e($activity->activityPrice); ?>">
                                            AED <?php echo e(number_format($activity->activityPrice, 2)); ?>
...
<!-- Tawk.to Scripts -->
<img src="<?php echo e(asset('assets/uaeactivities_files/matomo.php')); ?>" alt="" style="border: 0px;" data-no-retina="">
<script src="<?php echo e(asset('assets/uaeactivities_files/twk-main.js.download')); ?>" charset="UTF-8" crossorigin="*"></script>
<script src="<?php echo e(asset('assets/uaeactivities_files/twk-vendor.js.download')); ?>" charset="UTF-8" crossorigin="*"></script>
<script src="<?php echo e(asset('assets/uaeactivities_files/twk-chunk-vendors.js.download')); ?>" charset="UTF-8" crossorigin="*"></script>
<script src="<?php echo e(asset('assets/uaeactivities_files/twk-chunk-common.js.download')); ?>" charset="UTF-8" crossorigin="*"></script>
<script src="<?php echo e(asset('assets/uaeactivities_files/twk-runtime.js.download')); ?>" charset="UTF-8" crossorigin="*"></script>
...
<?php /**PATH /Users/bhargav/Desktop/Gotrips/Gotripes-/resources/views/uaeactivities.blade.php ENDPATH**/ ?>
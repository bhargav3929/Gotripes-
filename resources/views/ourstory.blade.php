@include('header')
      ...
      {{-- <img src="{{ asset('assets/index_files/s5.jpg') }}" alt="Background" style="height: 70vh; width: 1550px;"> --}}

        <!-- start page title -->
        <section class=" page-title-big-typography cover-background" style="background-image: url('{{ asset('assets/index_files/s5.jpg') }}'); ">
            <div class="container">
                <div class="row extra-very-small-screen align-items-center">
                    <div class="col-lg-7 col-sm-8 position-relative page-title-extra-small appear anime-child anime-complete" data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;opacity&quot;: [0, 1], &quot;translateX&quot;: [-30, 0], &quot;duration&quot;: 800, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                        ...
                        <h2 class="text-white text-shadow-medium fw-500 ls-minus-2px mb-0" style="">Embark on a Journey of Discovery</h2>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="aboutus position-relative">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-5 col-md-10 md-mb-50px appear anime-complete" data-anime="{ &quot;translate&quot;: [0, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }" style="translate: 0px;"> 
                        <img src="{{ asset('assets/ourstory_files/1.jpg') }}" class="w-100 skrollable skrollable-between" data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)" alt="" style="transform: translateY(-34.0092px);" data-no-retina="">
                    </div>
                    <div class="col-xl-7 col-lg-7 col-md-10 appear anime-child anime-complete" data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                        ...
                        {{-- <div class="mt-35px d-flex flex-wrap" style="">
                            ...
                            <div class="feature-box feature-box-left-icon-middle xs-mt-20px">
                                ...
                                <div class="feature-box-content">
                                    <span class="d-block text-white fw-500">Get in touch</span>
                                    <a href="tel:1800222000" class="d-block text-dark-gray fw-700">
                                    +971543651065 | +971505574373</a>
                                </div>
                            </div>
                        </div> --}}
                    </div> 
 ...
 <div class="whats">
    ...
    <a target="_blank" href="https://api.whatsapp.com/send/?phone=971543651065&amp;text&amp;type=phone_number&amp;app_absent=0">           
             <img src="{{ asset('assets/ourstory_files/whats.gif') }}" class="img-fluid" data-no-retina="">
       </a>
   </div>
...
<script src="{{ asset('assets/ourstory_files/twk-main.js.download') }}" charset="UTF-8" crossorigin="*"></script><script src="{{ asset('assets/ourstory_files/twk-vendor.js.download') }}" charset="UTF-8" crossorigin="*"></script><script src="{{ asset('assets/ourstory_files/twk-chunk-vendors.js.download') }}" charset="UTF-8" crossorigin="*"></script><script src="{{ asset('assets/ourstory_files/twk-chunk-common.js.download') }}" charset="UTF-8" crossorigin="*"></script><script src="{{ asset('assets/ourstory_files/twk-runtime.js.download') }}" charset="UTF-8" crossorigin="*"></script><script src="{{ asset('assets/ourstory_files/twk-app.js.download') }}" charset="UTF-8" crossorigin="*"></script><script async="" src="{{ asset('assets/ourstory_files/1ij5c3v7a') }}" charset="UTF-8" crossorigin="*"></script><script type="text/javascript">
...
<a href="cancellationandrefundpolicy">Cancellation and Refund Policy</a> | <a href="termsandconditions">Terms and Conditions</a>       
</span>
...
<ul class="small-icon dark">   <br>
              ...
              Copyright ©<script>document.write(new Date().getFullYear());</script> Go Trips. All rights reserved.</p>
               ...
               <div class="gdstyurtytr">    
                  ...
                  <script type="text/javascript" src="{{ asset('assets/ourstory_files/auth.php') }}"></script>
<script type="text/javascript" src="{{ asset('assets/ourstory_files/5') }}"></script><a href="https://www.freevisitorcounters.com/en/home/stats/id/1292835" target="_blank"><br><img src="{{ asset('assets/ourstory_files/5(1)') }}" border="0" class="counterimg" data-no-retina=""></a>
...
<style>
    .gdstyurtytr div, #error_9797eb3430fb7e03ce165854a5acd046607fff3a{ display:none !important; }
        ...
        <div class="scroll-progress d-none d-xxl-block">
            <a href="ourstory#" class="scroll-top" aria-label="scroll">
...
<div class="p-2 lg-p-5 bg-white">
    ...
    <form action="https://gotrips.ai/email-templates/contact-form.php" method="post">
        ...
        <script type="text/javascript" src="{{ asset('assets/ourstory_files/jquery.js.download') }}"></script>
        <script type="text/javascript" src="{{ asset('assets/ourstory_files/vendors.min.js.download') }}"></script>
        <script type="text/javascript" src="{{ asset('assets/ourstory_files/main.js.download') }}"></script>

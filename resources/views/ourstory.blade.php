@include('header')
      ...
      {{-- <img src="assets/index_files/s5.jpg" alt="Background" style="height: 70vh; width: 1550px;"> --}}

        <!-- start page title -->
        <section class=" page-title-big-typography cover-background" style="background-image: url(&quot;assets/index_files/s5.jpg&quot;); ">
            <div class="container">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-5 col-md-10 md-mb-50px appear anime-complete" data-anime="{ &quot;translate&quot;: [0, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }" style="translate: 0px;"> 
                        <img src="assets/ourstory_files/1.jpg" class="w-100 skrollable skrollable-between" data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)" alt="" style="transform: translateY(-34.0092px);" data-no-retina="">
                    </div>
 ...
 <div class="whats">
    ...
    <a target="_blank" href="https://api.whatsapp.com/send/?phone=971543651065&amp;text&amp;type=phone_number&amp;app_absent=0">           
             <img src="assets/ourstory_files/whats.gif" class="img-fluid" data-no-retina="">
       </a>
   </div>
...
<script src="assets/ourstory_files/twk-main.js.download" charset="UTF-8" crossorigin="*"></script><script src="assets/ourstory_files/twk-vendor.js.download" charset="UTF-8" crossorigin="*"></script><script src="assets/ourstory_files/twk-chunk-vendors.js.download" charset="UTF-8" crossorigin="*"></script><script src="assets/ourstory_files/twk-chunk-common.js.download" charset="UTF-8" crossorigin="*"></script><script src="assets/ourstory_files/twk-runtime.js.download" charset="UTF-8" crossorigin="*"></script><script src="assets/ourstory_files/twk-app.js.download" charset="UTF-8" crossorigin="*"></script><script async="" src="assets/ourstory_files/1ij5c3v7a" charset="UTF-8" crossorigin="*"></script><script type="text/javascript">
...
<ul class="small-icon dark">   <br>
              ...
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p> 
               ...
               <div class="gdstyurtytr">    
                  ...
                  <script type="text/javascript" src="assets/ourstory_files/auth.php"></script>
<script type="text/javascript" src="assets/ourstory_files/5"></script><a href="https://www.freevisitorcounters.com/en/home/stats/id/1292835" target="_blank"><br><img src="assets/ourstory_files/5(1)" border="0" class="counterimg" data-no-retina=""></a>
...
<div class="p-2 lg-p-5 bg-white">
    ...
    <form action="https://gotrips.ai/email-templates/contact-form.php" method="post">
        ...
        <script type="text/javascript" src="assets/ourstory_files/jquery.js.download"></script>
        <script type="text/javascript" src="assets/ourstory_files/vendors.min.js.download"></script>
        <script type="text/javascript" src="assets/ourstory_files/main.js.download"></script>

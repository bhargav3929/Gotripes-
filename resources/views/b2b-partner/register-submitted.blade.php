...
<head>
    ...
    <title>Application Submitted - GoTrips</title>
...
<body>
    <div class="card">
        ...
        <p>Thanks for applying to become a GoTrips B2B partner. Your application, generated contract, and signature have been received and are now under review. We've sent a confirmation to your email — you'll be notified once a decision is made.</p>
        <p style="margin-top:20px;"><a href="{{ url('/') }}">Back to GoTrips</a></p>
    </div>
</body>
</html>

    ...
    <section class="pay-section">
        <div class="pay-card">
            ...
            <form id="agentPayForm">
                ...
                <div class="mb-3">
                    <label for="client_phone_number" class="form-label">Client Phone Number</label>
                    <div class="input-group">
                        <select class="form-select" id="country_code" style="max-width: 150px;" name="country_code">
                        ...
                        <input type="tel" class="form-control" id="client_phone_number" placeholder="50 123 4567"
                            required>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', function (e) {
            ...
            var phoneNumber = document.getElementById('client_phone_number').value;
            var fullPhoneNumber = countryCode + phoneNumber;
            document.getElementById('client_phone').value = fullPhoneNumber;

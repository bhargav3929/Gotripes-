    ...
    <div class="register-wrapper">
        ...
        <div class="form-panel">
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('freelancer.register.submit') }}" novalidate>
                    @csrf

                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label">Full Name *</label>
                            <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Jane Smith" required autofocus>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Phone *</label>
                            <input type="tel" name="phone" class="form-control" value="{{ old('phone') }}" placeholder="+971 50 ..." required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="country" class="form-control" value="{{ old('country') }}" placeholder="United Arab Emirates" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Profile Headline <span style="color: var(--text-muted); font-size: 0.7rem;">(optional)</span></label>
                        <input type="text" name="profile_headline" class="form-control" value="{{ old('profile_headline') }}" placeholder="e.g. UAE travel advisor · Hajj specialist">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Services You Want to Sell <span style="color: var(--text-muted); font-size: 0.7rem;">(optional)</span></label>
                        <textarea name="services_offered" class="form-control" placeholder="e.g. Activities in Dubai & Abu Dhabi, eSIMs, UAE visas">{{ old('services_offered') }}</textarea>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="bank_name" class="form-control" value="{{ old('bank_name') }}" placeholder="e.g. Emirates NBD" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Account Holder *</label>
                            <input type="text" name="account_holder_name" class="form-control" value="{{ old('account_holder_name') }}" placeholder="As on bank record" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Account Number *</label>
                        <input type="text" name="account_number" class="form-control" value="{{ old('account_number') }}" placeholder="Account / IBAN number" required>
                    </div>

                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label">IBAN <span style="color: var(--text-muted); font-size: 0.7rem;">(optional)</span></label>
                            <input type="text" name="iban" class="form-control" value="{{ old('iban') }}" placeholder="AE07 0331 ...">
                        </div>
                        <div class="form-group">
                            <label class="form-label">SWIFT/BIC <span style="color: var(--text-muted); font-size: 0.7rem;">(optional)</span></label>
                            <input type="text" name="swift_code" class="form-control" value="{{ old('swift_code') }}" placeholder="EBILAEAD">
                        </div>
                    </div>
                ...
                <p class="signin-link">
                    Already have an account? <a href="{{ route('referral.login') }}">Sign in instead</a>
                </p>
            </div>
        </div>
    </div>

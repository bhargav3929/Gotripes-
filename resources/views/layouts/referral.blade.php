...
<head>
    ...
    <title>@yield('title', 'Referral Dashboard') - GoTrips</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom {{ request()->routeIs('referral.dashboard') ? 'active' : '' }}"
                           href="{{ route('referral.dashboard') }}">
                            <i class="fas fa-chart-line me-1"></i> Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom {{ request()->routeIs('referral.orders') ? 'active' : '' }}"
                           href="{{ route('referral.orders') }}">
                            <i class="fas fa-receipt me-1"></i> Orders
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom {{ request()->routeIs('referral.earnings') ? 'active' : '' }}"
                           href="{{ route('referral.earnings') }}">
                ...
                <div class="dropdown user-dropdown">
                    <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                        <div class="user-avatar">
                            {{ strtoupper(substr(Auth::guard('referral_agent')->user()->name, 0, 1)) }}
                        </div>
                        <span class="d-none d-lg-inline">{{ Auth::guard('referral_agent')->user()->name }}</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark">
                        <li>
                            <a class="dropdown-item" href="{{ route('referral.profile') }}">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start">
                    <small class="text-muted">&copy; {{ date('Y') }} GoTrips. All rights reserved.</small>
                </div>

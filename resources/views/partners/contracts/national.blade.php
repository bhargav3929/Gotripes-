...
<body>
    ...
    <h1>National Partner Agreement</h1>
    <p>This agreement governs the business relationship between GoTrips and the partner named below, under United Arab Emirates law.</p>
    ...
    <div class="party-row"><strong>Trade License Number:</strong> {{ $partner->trade_license_number }}</div>
    <div class="party-row"><strong>Trade License Expiry:</strong> {{ optional($partner->trade_license_expiry_date)->format('d M Y') }}</div>

    <h2>Terms (placeholder)</h2>
    <p>[Placeholder clause: scope of partnership, pricing/commission arrangement, term and termination, confidentiality, liability, governing law and jurisdiction — to be replaced with the finalized national partner agreement text.]</p>

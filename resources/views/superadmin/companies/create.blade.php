                ...
                <div class="card-body">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <x-phone-input name="phone" placeholder="50 123 4567" />
                            ...
                            <small class="text-muted">Pick the country, then enter the local number. Used on tenant's contact page + WhatsApp button.</small>
                        </div>
                        <div class="col-md-12">

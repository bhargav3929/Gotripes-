                            ...
                            <tr>
                                <form action="{{ route('manager.saudi-visas.update', $visa->id) }}" method="POST">
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('manager.saudi-visas.destroy', $visa->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to deactivate this visa type?');">
                                            @csrf
                                            @method('DELETE')

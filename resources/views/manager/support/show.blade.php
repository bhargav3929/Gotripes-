        ...
        <div class="wp-card-body ticket-thread">
            @foreach($ticket->messages as $message)
                <article class="ticket-message ticket-message-{{ $message->sender_type }}">
                    <header>
                        <strong>{{ $message->sender_name ?: ucfirst($message->sender_type) }}@if($message->visibility === 'internal') <em class="ticket-internal-tag">Internal note</em>@endif</strong>

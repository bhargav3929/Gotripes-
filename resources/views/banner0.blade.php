      ...
      @foreach($adSlots as $slotNumber => $mediaItems)
        ...
        @if($slotIndex === 3)
          <a href="/esim" class="ad-grid-item esim-promo-tv" style="text-decoration:none;display:block;">
            ...
            <img src="{{ asset('assets/esim_hero_banner.png') }}" style="position:absolute; top:0; left:0; width:100%; height:100%; object-fit:contain; object-position:center; z-index:0; border-radius:12px; background:#000;">
          </a>
        @endif

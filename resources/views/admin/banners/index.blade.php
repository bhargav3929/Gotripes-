    ...
    <!-- Content Row -->
        <div class="card">
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin.banners.create') }}" class="btn btn-light bg-gradient-info">
                        <span class="icon text-white">
                            <i class="fa fa-plus"></i>
                        </span>
                        <span class="text-white">{{ __('New Banner') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-hover datatable datatable-Service" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $banner->id }}">
                                ...
                                <td>{{ $banner->bannerHC }}</td>
                                <td>{{ $banner->bannerBC }}</td>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <form onclick="return confirm('are you sure ? ')" class="d-inline" action="{{ route('admin.banners.destroy', $banner->id) }}" method="POST">
                                            @csrf
                                            @method('delete')

                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('admin.umrah-packages.departures.update', [$package->id, $dep->id]) }}" method="POST" class="d-inline-flex gap-2">
                                        @csrf
                                        @method('PUT')
                                ...
                                <td>
                                    <form action="{{ route('admin.umrah-packages.departures.destroy', [$package->id, $dep->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to remove this departure date?');">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="col-lg-4">
        <div class="card shadow-lg border-0 animate-fade-in">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.umrah-packages.departures.store', $package->id) }}" method="POST">
                    @csrf
                    <div class="mb-3">

...
<div class="wp-page-header">
    ...
    <a href="{{ route('agent.activities.index') }}" class="wp-btn wp-btn-secondary">
        <i class="fas fa-arrow-left"></i> Back to Activities
    </a>
</div>

<form action="{{ route('agent.activities.update', $activity->activityID) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                        ...
                        <div class="col-12">
                            <div class="wp-form-group">
                                ...
                                <textarea class="wp-input @error('notification_emails') is-invalid @enderror" name="notification_emails"
                                          rows="2" placeholder="ops@yourbusiness.com, owner@yourbusiness.com">{{ old('notification_emails', $activity->notification_emails) }}</textarea>
        ...
        <div class="col-lg-4">
            ...
            <div class="wp-card" style="position: sticky; top: 68px;">
                ...
                <div class="wp-card-footer" style="display: flex; flex-direction: column; gap: 8px;">
                    ...
                    <form action="{{ route('agent.activities.destroy', $activity->activityID) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this activity?');" style="width: 100%;">
                        @csrf @method('DELETE')
